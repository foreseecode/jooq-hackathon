...
public class MultirangeUnion extends AbstractRoutine<Object> {
     ...
     */
    public MultirangeUnion() {
        super("multirange_union", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anymultirange\""));
