...
public class BrinMinmaxMultiDistanceTime extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.brin_minmax_multi_distance_time.RETURN_VALUE</code>.
     */
     ...
     */
    public BrinMinmaxMultiDistanceTime() {
        super("brin_minmax_multi_distance_time", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
