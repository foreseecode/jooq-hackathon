...
public class Ginarraytriconsistent extends AbstractRoutine<String> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> _3 = Internal.createParameter("_3", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anyarray\""), false, true);
    ...
    public Ginarraytriconsistent() {
        super("ginarraytriconsistent", PgCatalog.PG_CATALOG, SQLDataType.CHAR);
