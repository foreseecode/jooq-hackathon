...
public class PgForeignServer extends TableImpl<PgForeignServerRecord> {
     ...
     */
    public final TableField<PgForeignServerRecord, String[]> SRVACL = createField(DSL.name("srvacl"), SQLDataType.VARCHAR.getArrayDataType(), this, "");

    /**
     * The column <code>pg_catalog.pg_foreign_server.srvoptions</code>.
     */
    public final TableField<PgForeignServerRecord, String[]> SRVOPTIONS = createField(DSL.name("srvoptions"), SQLDataType.CLOB.getArrayDataType(), this, "");
