...
public class VarbitSupport extends AbstractRoutine<Object> {
     ...
     */
    public VarbitSupport() {
        super("varbit_support", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
