...
import com.verint.mpathy.db.live_core.tables.records._SessionSelectionRecord;
...
public class _SessionSelection extends TableImpl<_SessionSelectionRecord> {
    ...
    /**
     * The reference instance of <code>live_core._session_selection</code>
     */
    ...
    /**
     * The column <code>live_core._session_selection.idsession</code>.
     */
    ...
    private _SessionSelection(Name alias, Table<_SessionSelectionRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"_session_selection\" as  SELECT _session_selection.idsession\n   FROM live._session_selection;"));
    }

    /**
     * Create an aliased <code>live_core._session_selection</code> table
     * reference
     */
    ...
    /**
     * Create a <code>live_core._session_selection</code> table reference
     */
