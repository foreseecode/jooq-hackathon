...
import com.verint.mpathy.db.information_schema.tables.records.RoutinePrivilegesRecord;
...
public class RoutinePrivileges extends TableImpl<RoutinePrivilegesRecord> {
     ...
     */
    public final TableField<RoutinePrivilegesRecord, String> GRANTOR = createField(DSL.name("grantor"), com.verint.mpathy.db.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column <code>information_schema.routine_privileges.grantee</code>.
     */
    public final TableField<RoutinePrivilegesRecord, String> GRANTEE = createField(DSL.name("grantee"), com.verint.mpathy.db.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.routine_privileges.specific_catalog</code>.
     */
    public final TableField<RoutinePrivilegesRecord, String> SPECIFIC_CATALOG = createField(DSL.name("specific_catalog"), com.verint.mpathy.db.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.routine_privileges.specific_schema</code>.
     */
    public final TableField<RoutinePrivilegesRecord, String> SPECIFIC_SCHEMA = createField(DSL.name("specific_schema"), com.verint.mpathy.db.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.routine_privileges.specific_name</code>.
     */
    public final TableField<RoutinePrivilegesRecord, String> SPECIFIC_NAME = createField(DSL.name("specific_name"), com.verint.mpathy.db.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.routine_privileges.routine_catalog</code>.
     */
    public final TableField<RoutinePrivilegesRecord, String> ROUTINE_CATALOG = createField(DSL.name("routine_catalog"), com.verint.mpathy.db.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.routine_privileges.routine_schema</code>.
     */
    public final TableField<RoutinePrivilegesRecord, String> ROUTINE_SCHEMA = createField(DSL.name("routine_schema"), com.verint.mpathy.db.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.routine_privileges.routine_name</code>.
     */
    public final TableField<RoutinePrivilegesRecord, String> ROUTINE_NAME = createField(DSL.name("routine_name"), com.verint.mpathy.db.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.routine_privileges.privilege_type</code>.
     */
    public final TableField<RoutinePrivilegesRecord, String> PRIVILEGE_TYPE = createField(DSL.name("privilege_type"), com.verint.mpathy.db.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.routine_privileges.is_grantable</code>.
     */
    public final TableField<RoutinePrivilegesRecord, String> IS_GRANTABLE = createField(DSL.name("is_grantable"), com.verint.mpathy.db.information_schema.Domains.YES_OR_NO.getDataType(), this, "");
