...
public class PgLsnLarger extends AbstractRoutine<Object> {
     ...
     */
    public PgLsnLarger() {
        super("pg_lsn_larger", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_lsn\""));
