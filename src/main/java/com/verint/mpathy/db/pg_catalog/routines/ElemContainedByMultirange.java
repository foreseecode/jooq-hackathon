...
public class ElemContainedByMultirange extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.elem_contained_by_multirange.RETURN_VALUE</code>.
     */
     ...
     */
    public ElemContainedByMultirange() {
        super("elem_contained_by_multirange", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN);
