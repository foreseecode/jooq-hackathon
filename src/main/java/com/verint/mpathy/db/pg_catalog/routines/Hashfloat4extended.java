...
public class Hashfloat4extended extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.hashfloat4extended.RETURN_VALUE</code>.
     */
    public static final Parameter<Long> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>pg_catalog.hashfloat4extended._1</code>.
     */
    public static final Parameter<Float> _1 = Internal.createParameter("_1", SQLDataType.REAL, false, true);

    /**
     * The parameter <code>pg_catalog.hashfloat4extended._2</code>.
     */
     ...
     */
    public Hashfloat4extended() {
        super("hashfloat4extended", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
