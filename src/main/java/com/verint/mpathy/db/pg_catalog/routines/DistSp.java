...
public class DistSp extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.dist_sp.RETURN_VALUE</code>.
     */
     ...
     */
    public DistSp() {
        super("dist_sp", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
