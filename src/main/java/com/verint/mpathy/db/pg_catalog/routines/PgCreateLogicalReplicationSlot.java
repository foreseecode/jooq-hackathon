...
public class PgCreateLogicalReplicationSlot extends AbstractRoutine<java.lang.Void> {
     ...
     */
    public static final Parameter<Boolean> TWOPHASE = Internal.createParameter("twophase", SQLDataType.BOOLEAN.defaultValue(DSL.field("false", SQLDataType.BOOLEAN)), true, false);
