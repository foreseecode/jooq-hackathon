...
import com.verint.mpathy.db.live_core.tables.records.TaskActionRecord;
...
public class TaskAction extends TableImpl<TaskActionRecord> {
    ...
    /**
     * The reference instance of <code>live_core.task_action</code>
     */
    ...
    private TaskAction(Name alias, Table<TaskActionRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"task_action\" as  SELECT task_action.idtask,\n    task_action.idsession,\n    task_action.\"timestamp\",\n    task_action.idsite,\n    task_action.last_taskitem,\n    task_action.last_pi,\n    task_action.length_loaded,\n    task_action.length_active,\n    task_action.length_visible,\n    task_action.num_pi,\n    task_action.num_clicks,\n    task_action.completed\n   FROM live.task_action;"));
    }

    /**
     * Create an aliased <code>live_core.task_action</code> table reference
     */
    ...
    /**
     * Create a <code>live_core.task_action</code> table reference
     */
    public TaskAction() {
