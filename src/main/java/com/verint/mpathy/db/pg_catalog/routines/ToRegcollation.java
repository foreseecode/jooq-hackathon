...
public class ToRegcollation extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"regcollation\""), false, false);

    /**
     * The parameter <code>pg_catalog.to_regcollation._1</code>.
     */
     ...
     */
    public ToRegcollation() {
        super("to_regcollation", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"regcollation\""));
