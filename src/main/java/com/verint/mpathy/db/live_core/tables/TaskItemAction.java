...
import com.verint.mpathy.db.live_core.tables.records.TaskItemActionRecord;
...
public class TaskItemAction extends TableImpl<TaskItemActionRecord> {
    ...
    /**
     * The reference instance of <code>live_core.task_item_action</code>
     */
    ...
    /**
     * The column <code>live_core.task_item_action.idtaskitem</code>.
     */
    public final TableField<TaskItemActionRecord, BigDecimal> IDTASKITEM = createField(DSL.name("idtaskitem"), SQLDataType.NUMERIC, this, "");

    /**
     * The column <code>live_core.task_item_action.idtask</code>.
     */
    public final TableField<TaskItemActionRecord, Long> IDTASK = createField(DSL.name("idtask"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>live_core.task_item_action.idsession</code>.
     */
    public final TableField<TaskItemActionRecord, BigDecimal> IDSESSION = createField(DSL.name("idsession"), SQLDataType.NUMERIC, this, "");

    /**
     * The column <code>live_core.task_item_action.timestamp_taskaction</code>.
     */
    public final TableField<TaskItemActionRecord, BigDecimal> TIMESTAMP_TASKACTION = createField(DSL.name("timestamp_taskaction"), SQLDataType.NUMERIC, this, "");

    /**
     * The column <code>live_core.task_item_action.timestamp</code>.
     */
    ...
    private TaskItemAction(Name alias, Table<TaskItemActionRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"task_item_action\" as  SELECT task_item_action.idtaskitem,\n    task_item_action.idtask,\n    task_item_action.idsession,\n    task_item_action.timestamp_taskaction,\n    task_item_action.\"timestamp\",\n    task_item_action.idsite,\n    task_item_action.num_pi,\n    task_item_action.num_clicks\n   FROM live.task_item_action;"));
    }

    /**
     * Create an aliased <code>live_core.task_item_action</code> table reference
     */
    ...
    /**
     * Create a <code>live_core.task_item_action</code> table reference
     */
