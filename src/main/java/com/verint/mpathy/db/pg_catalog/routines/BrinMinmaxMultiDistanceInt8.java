...
public class BrinMinmaxMultiDistanceInt8 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.brin_minmax_multi_distance_int8.RETURN_VALUE</code>.
     */
     ...
     */
    public BrinMinmaxMultiDistanceInt8() {
        super("brin_minmax_multi_distance_int8", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
