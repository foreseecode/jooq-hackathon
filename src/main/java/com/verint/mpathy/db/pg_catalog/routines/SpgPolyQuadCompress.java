...
public class SpgPolyQuadCompress extends AbstractRoutine<Object> {
     ...
     */
    public SpgPolyQuadCompress() {
        super("spg_poly_quad_compress", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"box\""));
