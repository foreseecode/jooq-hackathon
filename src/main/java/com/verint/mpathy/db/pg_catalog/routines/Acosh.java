...
public class Acosh extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.acosh.RETURN_VALUE</code>.
     */
    public static final Parameter<Double> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.DOUBLE, false, false);

    /**
     * The parameter <code>pg_catalog.acosh._1</code>.
     */
     ...
     */
    public Acosh() {
        super("acosh", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
