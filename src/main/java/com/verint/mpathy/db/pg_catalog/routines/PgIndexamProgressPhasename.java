...
public class PgIndexamProgressPhasename extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.pg_indexam_progress_phasename.RETURN_VALUE</code>.
     */
    public static final Parameter<String> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>pg_catalog.pg_indexam_progress_phasename._1</code>.
     */
    public static final Parameter<Long> _1 = Internal.createParameter("_1", SQLDataType.BIGINT, false, true);

    /**
     * The parameter <code>pg_catalog.pg_indexam_progress_phasename._2</code>.
     */
     ...
     */
    public PgIndexamProgressPhasename() {
        super("pg_indexam_progress_phasename", PgCatalog.PG_CATALOG, SQLDataType.CLOB);
