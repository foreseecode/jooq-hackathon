...
public class PgMcvListOut extends AbstractRoutine<Object> {
     ...
     */
    public PgMcvListOut() {
        super("pg_mcv_list_out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
