...
public class JsonObjectAggFinalfn extends AbstractRoutine<JSON> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.json_object_agg_finalfn.RETURN_VALUE</code>.
     */
    ...
    public JsonObjectAggFinalfn() {
        super("json_object_agg_finalfn", PgCatalog.PG_CATALOG, SQLDataType.JSON);
