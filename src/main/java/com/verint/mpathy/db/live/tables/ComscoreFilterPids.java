...
import com.verint.mpathy.db.live.tables.records.ComscoreFilterPidsRecord;
...
public class ComscoreFilterPids extends TableImpl<ComscoreFilterPidsRecord> {
    ...
    /**
     * The reference instance of <code>live.comscore_filter_pids</code>
     */
    ...
    /**
     * The column <code>live.comscore_filter_pids.idclient</code>.
     */
    public final TableField<ComscoreFilterPidsRecord, BigDecimal> IDCLIENT = createField(DSL.name("idclient"), SQLDataType.NUMERIC.nullable(false), this, "");

    /**
     * The column <code>live.comscore_filter_pids.idfilter</code>.
     */
    public final TableField<ComscoreFilterPidsRecord, BigDecimal> IDFILTER = createField(DSL.name("idfilter"), SQLDataType.NUMERIC.nullable(false), this, "");

    /**
     * The column <code>live.comscore_filter_pids.idpage</code>.
     */
    public final TableField<ComscoreFilterPidsRecord, BigDecimal> IDPAGE = createField(DSL.name("idpage"), SQLDataType.NUMERIC.nullable(false), this, "");

    /**
     * The column <code>live.comscore_filter_pids.date</code>.
     */
    ...
    /**
     * Create an aliased <code>live.comscore_filter_pids</code> table reference
     */
    ...
    /**
     * Create a <code>live.comscore_filter_pids</code> table reference
     */
