...
public class Hashenumextended extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.hashenumextended.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.hashenumextended._2</code>.
     */
     ...
     */
    public Hashenumextended() {
        super("hashenumextended", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
