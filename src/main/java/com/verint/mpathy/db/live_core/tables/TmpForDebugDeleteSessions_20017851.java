...
import com.verint.mpathy.db.live_core.tables.records.TmpForDebugDeleteSessions_20017851Record;
...
public class TmpForDebugDeleteSessions_20017851 extends TableImpl<TmpForDebugDeleteSessions_20017851Record> {
     ...
     * <code>live_core.tmp_for_debug_delete_sessions_20017851</code>
     */
    ...
    private TmpForDebugDeleteSessions_20017851(Name alias, Table<TmpForDebugDeleteSessions_20017851Record> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"tmp_for_debug_delete_sessions_20017851\" as  SELECT tmp_for_debug_delete_sessions_20017851.idsite,\n    tmp_for_debug_delete_sessions_20017851.idvisitor,\n    tmp_for_debug_delete_sessions_20017851.idsession,\n    tmp_for_debug_delete_sessions_20017851.idpage,\n    tmp_for_debug_delete_sessions_20017851.scaffold\n   FROM live.tmp_for_debug_delete_sessions_20017851;"));
    }

    /**
     * Create an aliased
     * <code>live_core.tmp_for_debug_delete_sessions_20017851</code> table
     * reference
     */
    ...
    /**
     * Create a <code>live_core.tmp_for_debug_delete_sessions_20017851</code>
     * table reference
     */
