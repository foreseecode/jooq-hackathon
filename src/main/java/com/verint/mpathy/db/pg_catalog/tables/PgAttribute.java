...
public class PgAttribute extends TableImpl<PgAttributeRecord> {
     ...
     */
    public final TableField<PgAttributeRecord, Integer> ATTSTATTARGET = createField(DSL.name("attstattarget"), SQLDataType.INTEGER.nullable(false), this, "");
     ...
     */
    public final TableField<PgAttributeRecord, Integer> ATTNDIMS = createField(DSL.name("attndims"), SQLDataType.INTEGER.nullable(false), this, "");
     ...
     */
    public final TableField<PgAttributeRecord, Integer> ATTINHCOUNT = createField(DSL.name("attinhcount"), SQLDataType.INTEGER.nullable(false), this, "");
     ...
     */
    public final TableField<PgAttributeRecord, String[]> ATTACL = createField(DSL.name("attacl"), SQLDataType.VARCHAR.getArrayDataType(), this, "");

    /**
     * The column <code>pg_catalog.pg_attribute.attoptions</code>.
     */
    public final TableField<PgAttributeRecord, String[]> ATTOPTIONS = createField(DSL.name("attoptions"), SQLDataType.CLOB.getArrayDataType(), this, "");

    /**
     * The column <code>pg_catalog.pg_attribute.attfdwoptions</code>.
     */
    public final TableField<PgAttributeRecord, String[]> ATTFDWOPTIONS = createField(DSL.name("attfdwoptions"), SQLDataType.CLOB.getArrayDataType(), this, "");
     ...
     */
    @Deprecated
    public final TableField<PgAttributeRecord, Object> ATTMISSINGVAL = createField(DSL.name("attmissingval"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anyarray\""), this, "");
