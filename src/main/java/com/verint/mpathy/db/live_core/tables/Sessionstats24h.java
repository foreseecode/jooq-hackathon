...
import com.verint.mpathy.db.live_core.tables.records.Sessionstats24hRecord;
...
public class Sessionstats24h extends TableImpl<Sessionstats24hRecord> {
    ...
    /**
     * The reference instance of <code>live_core.sessionstats24h</code>
     */
    ...
    /**
     * The column <code>live_core.sessionstats24h.idsite</code>.
     */
    public final TableField<Sessionstats24hRecord, Integer> IDSITE = createField(DSL.name("idsite"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>live_core.sessionstats24h.hour</code>.
     */
    public final TableField<Sessionstats24hRecord, Short> HOUR = createField(DSL.name("hour"), SQLDataType.SMALLINT, this, "");

    /**
     * The column <code>live_core.sessionstats24h.sessions</code>.
     */
    public final TableField<Sessionstats24hRecord, Long> SESSIONS = createField(DSL.name("sessions"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>live_core.sessionstats24h.statsrequests</code>.
     */
    ...
    private Sessionstats24h(Name alias, Table<Sessionstats24hRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"sessionstats24h\" as  SELECT sessionstats24h.idsite,\n    sessionstats24h.hour,\n    sessionstats24h.sessions,\n    sessionstats24h.statsrequests\n   FROM live.sessionstats24h;"));
    }

    /**
     * Create an aliased <code>live_core.sessionstats24h</code> table reference
     */
    ...
    /**
     * Create a <code>live_core.sessionstats24h</code> table reference
     */
