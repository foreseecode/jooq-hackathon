...
public class PgStatGetLastAutoanalyzeTime extends AbstractRoutine<OffsetDateTime> {
    ...
    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_last_autoanalyze_time.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_last_autoanalyze_time._1</code>.
     */
    ...
    public PgStatGetLastAutoanalyzeTime() {
        super("pg_stat_get_last_autoanalyze_time", PgCatalog.PG_CATALOG, SQLDataType.TIMESTAMPWITHTIMEZONE(6));
