 ...
 */
package com.verint.mpathy.db.information_schema.routines;
...
public class _PgTruetypmod extends AbstractRoutine<Integer> {
     ...
     */
    public static final Parameter<PgAttributeRecord> _1 = Internal.createParameter("_1", com.verint.mpathy.db.pg_catalog.tables.PgAttribute.PG_ATTRIBUTE.getDataType(), false, true);

    /**
     * The parameter <code>information_schema._pg_truetypmod._2</code>.
     */
    public static final Parameter<PgTypeRecord> _2 = Internal.createParameter("_2", com.verint.mpathy.db.pg_catalog.tables.PgType.PG_TYPE.getDataType(), false, true);
