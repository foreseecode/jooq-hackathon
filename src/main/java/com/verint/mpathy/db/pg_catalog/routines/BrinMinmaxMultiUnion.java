...
public class BrinMinmaxMultiUnion extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.brin_minmax_multi_union.RETURN_VALUE</code>.
     */
     ...
     */
    public BrinMinmaxMultiUnion() {
        super("brin_minmax_multi_union", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN);
