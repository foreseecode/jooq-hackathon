...
public class Latin1ToMic extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.latin1_to_mic.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.latin1_to_mic._6</code>.
     */
     ...
     */
    public Latin1ToMic() {
        super("latin1_to_mic", PgCatalog.PG_CATALOG, SQLDataType.INTEGER);
