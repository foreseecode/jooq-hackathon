...
public class PgStatGetBgwriterTimedCheckpoints extends AbstractRoutine<Long> {
    ...
    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_bgwriter_timed_checkpoints.RETURN_VALUE</code>.
     */
    ...
    public PgStatGetBgwriterTimedCheckpoints() {
        super("pg_stat_get_bgwriter_timed_checkpoints", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
