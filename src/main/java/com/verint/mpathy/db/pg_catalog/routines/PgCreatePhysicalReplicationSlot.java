...
public class PgCreatePhysicalReplicationSlot extends AbstractRoutine<java.lang.Void> {
     ...
     */
    public static final Parameter<Boolean> IMMEDIATELY_RESERVE = Internal.createParameter("immediately_reserve", SQLDataType.BOOLEAN.defaultValue(DSL.field("false", SQLDataType.BOOLEAN)), true, false);

    /**
     * The parameter
     * <code>pg_catalog.pg_create_physical_replication_slot.temporary</code>.
     */
    public static final Parameter<Boolean> TEMPORARY = Internal.createParameter("temporary", SQLDataType.BOOLEAN.defaultValue(DSL.field("false", SQLDataType.BOOLEAN)), true, false);
