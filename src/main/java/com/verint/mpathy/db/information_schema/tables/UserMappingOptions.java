...
import com.verint.mpathy.db.information_schema.tables.records.UserMappingOptionsRecord;
...
public class UserMappingOptions extends TableImpl<UserMappingOptionsRecord> {
     ...
     */
    public final TableField<UserMappingOptionsRecord, String> AUTHORIZATION_IDENTIFIER = createField(DSL.name("authorization_identifier"), com.verint.mpathy.db.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.user_mapping_options.foreign_server_catalog</code>.
     */
    public final TableField<UserMappingOptionsRecord, String> FOREIGN_SERVER_CATALOG = createField(DSL.name("foreign_server_catalog"), com.verint.mpathy.db.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.user_mapping_options.foreign_server_name</code>.
     */
    public final TableField<UserMappingOptionsRecord, String> FOREIGN_SERVER_NAME = createField(DSL.name("foreign_server_name"), com.verint.mpathy.db.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.user_mapping_options.option_name</code>.
     */
    public final TableField<UserMappingOptionsRecord, String> OPTION_NAME = createField(DSL.name("option_name"), com.verint.mpathy.db.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.user_mapping_options.option_value</code>.
     */
    public final TableField<UserMappingOptionsRecord, String> OPTION_VALUE = createField(DSL.name("option_value"), com.verint.mpathy.db.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");
