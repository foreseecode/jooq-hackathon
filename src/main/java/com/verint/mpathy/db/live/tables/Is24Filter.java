...
import com.verint.mpathy.db.live.tables.records.Is24FilterRecord;
...
public class Is24Filter extends TableImpl<Is24FilterRecord> {
    ...
    /**
     * The reference instance of <code>live.is24_filter</code>
     */
    ...
    /**
     * The column <code>live.is24_filter.idfilter</code>.
     */
    public final TableField<Is24FilterRecord, BigDecimal> IDFILTER = createField(DSL.name("idfilter"), SQLDataType.NUMERIC.nullable(false), this, "");

    /**
     * The column <code>live.is24_filter.name</code>.
     */
    public final TableField<Is24FilterRecord, String> NAME = createField(DSL.name("name"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>live.is24_filter.scope</code>.
     */
    ...
    /**
     * Create an aliased <code>live.is24_filter</code> table reference
     */
    ...
    /**
     * Create a <code>live.is24_filter</code> table reference
     */
    public Is24Filter() {
