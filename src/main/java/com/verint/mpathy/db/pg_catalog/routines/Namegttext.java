...
public class Namegttext extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.namegttext.RETURN_VALUE</code>.
     */
    public static final Parameter<Boolean> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BOOLEAN, false, false);

    /**
     * The parameter <code>pg_catalog.namegttext._1</code>.
     */
    public static final Parameter<String> _1 = Internal.createParameter("_1", SQLDataType.VARCHAR, false, true);

    /**
     * The parameter <code>pg_catalog.namegttext._2</code>.
     */
     ...
     */
    public Namegttext() {
        super("namegttext", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN);
