...
public class Sha256 extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.sha256.RETURN_VALUE</code>.
     */
    public static final Parameter<byte[]> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BLOB, false, false);

    /**
     * The parameter <code>pg_catalog.sha256._1</code>.
     */
     ...
     */
    public Sha256() {
        super("sha256", PgCatalog.PG_CATALOG, SQLDataType.BLOB);
