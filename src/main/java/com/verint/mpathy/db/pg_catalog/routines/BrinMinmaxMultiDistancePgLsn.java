...
public class BrinMinmaxMultiDistancePgLsn extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.brin_minmax_multi_distance_pg_lsn.RETURN_VALUE</code>.
     */
     ...
     */
    public BrinMinmaxMultiDistancePgLsn() {
        super("brin_minmax_multi_distance_pg_lsn", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
