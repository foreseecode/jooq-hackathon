...
public class Sinh extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.sinh.RETURN_VALUE</code>.
     */
    public static final Parameter<Double> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.DOUBLE, false, false);

    /**
     * The parameter <code>pg_catalog.sinh._1</code>.
     */
     ...
     */
    public Sinh() {
        super("sinh", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
