...
public class Latin2ToMic extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.latin2_to_mic.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.latin2_to_mic._6</code>.
     */
     ...
     */
    public Latin2ToMic() {
        super("latin2_to_mic", PgCatalog.PG_CATALOG, SQLDataType.INTEGER);
