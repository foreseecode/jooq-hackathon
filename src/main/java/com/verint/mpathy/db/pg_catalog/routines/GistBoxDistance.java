...
public class GistBoxDistance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.gist_box_distance.RETURN_VALUE</code>.
     */
     ...
     */
    @Deprecated
    public static final Parameter<Object> _2 = Internal.createParameter("_2", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"box\""), false, true);

    /**
     * The parameter <code>pg_catalog.gist_box_distance._3</code>.
     */
    public static final Parameter<Short> _3 = Internal.createParameter("_3", SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>pg_catalog.gist_box_distance._4</code>.
     */
     ...
     */
    public GistBoxDistance() {
        super("gist_box_distance", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
