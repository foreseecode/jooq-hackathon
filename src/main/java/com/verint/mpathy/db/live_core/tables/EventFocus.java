...
import com.verint.mpathy.db.live_core.tables.records.EventFocusRecord;
...
public class EventFocus extends TableImpl<EventFocusRecord> {
    ...
    /**
     * The reference instance of <code>live_core.event_focus</code>
     */
    ...
    private EventFocus(Name alias, Table<EventFocusRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"event_focus\" as  SELECT event_focus.idpage,\n    event_focus.idelement,\n    event_focus.\"timestamp\",\n    event_focus.idsite,\n    event_focus.idsession,\n    event_focus.value,\n    event_focus.uniquekey\n   FROM live.event_focus;"));
    }

    /**
     * Create an aliased <code>live_core.event_focus</code> table reference
     */
    ...
    /**
     * Create a <code>live_core.event_focus</code> table reference
     */
    public EventFocus() {
