...
public class MultirangeIntersectAggTransfn extends AbstractRoutine<Object> {
     ...
     */
    public MultirangeIntersectAggTransfn() {
        super("multirange_intersect_agg_transfn", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anymultirange\""));
