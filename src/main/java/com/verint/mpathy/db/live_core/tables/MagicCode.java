...
import com.verint.mpathy.db.live_core.tables.records.MagicCodeRecord;
...
public class MagicCode extends TableImpl<MagicCodeRecord> {
    ...
    /**
     * The reference instance of <code>live_core.magic_code</code>
     */
    ...
    private MagicCode(Name alias, Table<MagicCodeRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"magic_code\" as  SELECT magic_code.code,\n    magic_code.used_by,\n    magic_code.used_at\n   FROM live.magic_code;"));
    }

    /**
     * Create an aliased <code>live_core.magic_code</code> table reference
     */
    ...
    /**
     * Create a <code>live_core.magic_code</code> table reference
     */
    public MagicCode() {
