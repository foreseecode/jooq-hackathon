...
public class MultirangeRecv extends AbstractRoutine<Object> {
    ...
    /**
     * The parameter <code>pg_catalog.multirange_recv._2</code>.
     */
    public static final Parameter<Long> _2 = Internal.createParameter("_2", SQLDataType.BIGINT, false, true);

    /**
     * The parameter <code>pg_catalog.multirange_recv._3</code>.
     */
     ...
     */
    public MultirangeRecv() {
        super("multirange_recv", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anymultirange\""));
