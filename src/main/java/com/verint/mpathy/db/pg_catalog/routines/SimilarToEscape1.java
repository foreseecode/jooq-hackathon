...
public class SimilarToEscape1 extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.similar_to_escape.RETURN_VALUE</code>.
     */
    public static final Parameter<String> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>pg_catalog.similar_to_escape._1</code>.
     */
    public static final Parameter<String> _1 = Internal.createParameter("_1", SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>pg_catalog.similar_to_escape._2</code>.
     */
     ...
     */
    public SimilarToEscape1() {
        super("similar_to_escape", PgCatalog.PG_CATALOG, SQLDataType.CLOB);
