...
public class PgClass extends TableImpl<PgClassRecord> {
     ...
     */
    public final TableField<PgClassRecord, String[]> RELACL = createField(DSL.name("relacl"), SQLDataType.VARCHAR.getArrayDataType(), this, "");

    /**
     * The column <code>pg_catalog.pg_class.reloptions</code>.
     */
    public final TableField<PgClassRecord, String[]> RELOPTIONS = createField(DSL.name("reloptions"), SQLDataType.CLOB.getArrayDataType(), this, "");
