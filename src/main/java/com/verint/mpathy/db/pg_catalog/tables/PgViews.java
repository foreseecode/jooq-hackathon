...
import com.verint.mpathy.db.pg_catalog.tables.records.PgViewsRecord;
...
public class PgViews extends TableImpl<PgViewsRecord> {
    ...
    private PgViews(Name alias, Table<PgViewsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view \"pg_views\" as  SELECT n.nspname AS schemaname,\n    c.relname AS viewname,\n    pg_get_userbyid(c.relowner) AS viewowner,\n    pg_get_viewdef(c.oid) AS definition\n   FROM (pg_class c\n     LEFT JOIN pg_namespace n ON ((n.oid = c.relnamespace)))\n  WHERE (c.relkind = 'v'::\"char\");"));
    }
