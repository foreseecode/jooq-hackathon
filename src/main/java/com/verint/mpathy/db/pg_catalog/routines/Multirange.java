...
public class Multirange extends AbstractRoutine<Object> {
     ...
     */
    public Multirange() {
        super("multirange", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anymultirange\""));
