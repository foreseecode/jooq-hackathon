...
public class PgStatGetDbConflictBufferpin extends AbstractRoutine<Long> {
    ...
    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_db_conflict_bufferpin.RETURN_VALUE</code>.
     */
    public static final Parameter<Long> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BIGINT, false, false);

    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_db_conflict_bufferpin._1</code>.
     */
    ...
    public PgStatGetDbConflictBufferpin() {
        super("pg_stat_get_db_conflict_bufferpin", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
