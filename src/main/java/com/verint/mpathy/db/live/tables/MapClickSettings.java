...
import com.verint.mpathy.db.live.tables.records.MapClickSettingsRecord;
...
public class MapClickSettings extends TableImpl<MapClickSettingsRecord> {
    ...
    /**
     * The reference instance of <code>live.map_click_settings</code>
     */
    ...
    /**
     * The column <code>live.map_click_settings.idsite</code>.
     */
    public final TableField<MapClickSettingsRecord, Integer> IDSITE = createField(DSL.name("idsite"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>live.map_click_settings.idpage_name</code>.
     */
    public final TableField<MapClickSettingsRecord, Long> IDPAGE_NAME = createField(DSL.name("idpage_name"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>live.map_click_settings.pattern</code>.
     */
    public final TableField<MapClickSettingsRecord, String> PATTERN = createField(DSL.name("pattern"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>live.map_click_settings.replacement</code>.
     */
    public final TableField<MapClickSettingsRecord, String> REPLACEMENT = createField(DSL.name("replacement"), SQLDataType.CLOB.nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>live.map_click_settings</code> table reference
     */
    ...
    /**
     * Create a <code>live.map_click_settings</code> table reference
     */
