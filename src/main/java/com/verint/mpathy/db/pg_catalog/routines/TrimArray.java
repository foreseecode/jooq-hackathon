...
public class TrimArray extends AbstractRoutine<Object> {
    ...
    /**
     * The parameter <code>pg_catalog.trim_array._2</code>.
     */
     ...
     */
    public TrimArray() {
        super("trim_array", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anyarray\""));
