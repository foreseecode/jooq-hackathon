...
public class BrinMinmaxMultiDistanceFloat4 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.brin_minmax_multi_distance_float4.RETURN_VALUE</code>.
     */
     ...
     */
    public BrinMinmaxMultiDistanceFloat4() {
        super("brin_minmax_multi_distance_float4", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
