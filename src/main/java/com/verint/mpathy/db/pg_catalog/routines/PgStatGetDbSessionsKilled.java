...
public class PgStatGetDbSessionsKilled extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_db_sessions_killed.RETURN_VALUE</code>.
     */
    public static final Parameter<Long> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>pg_catalog.pg_stat_get_db_sessions_killed._1</code>.
     */
     ...
     */
    public PgStatGetDbSessionsKilled() {
        super("pg_stat_get_db_sessions_killed", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
