...
public class RangeAggTransfn extends AbstractRoutine<Object> {
     ...
     */
    public RangeAggTransfn() {
        super("range_agg_transfn", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
