...
public class RangeAgg extends AbstractRoutine<Object> {
     ...
     */
    public RangeAgg() {
        super("range_agg", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anymultirange\""));
