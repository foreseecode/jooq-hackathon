...
public class MicToSjis extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.mic_to_sjis.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.mic_to_sjis._6</code>.
     */
     ...
     */
    public MicToSjis() {
        super("mic_to_sjis", PgCatalog.PG_CATALOG, SQLDataType.INTEGER);
