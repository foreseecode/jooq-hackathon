...
public class PgSnapshotRecv extends AbstractRoutine<Object> {
     ...
     */
    public PgSnapshotRecv() {
        super("pg_snapshot_recv", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_snapshot\""));
