...
import com.verint.mpathy.db.live_core.tables.records.PageHasTagRecord;
...
public class PageHasTag extends TableImpl<PageHasTagRecord> {
    ...
    /**
     * The reference instance of <code>live_core.page_has_tag</code>
     */
    ...
    /**
     * The column <code>live_core.page_has_tag.idpage</code>.
     */
    public final TableField<PageHasTagRecord, BigDecimal> IDPAGE = createField(DSL.name("idpage"), SQLDataType.NUMERIC, this, "");

    /**
     * The column <code>live_core.page_has_tag.tag</code>.
     */
    public final TableField<PageHasTagRecord, String> TAG = createField(DSL.name("tag"), SQLDataType.CLOB, this, "");
    ...
    private PageHasTag(Name alias, Table<PageHasTagRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"page_has_tag\" as  SELECT page_has_tag.idpage,\n    page_has_tag.tag\n   FROM live.page_has_tag;"));
    }

    /**
     * Create an aliased <code>live_core.page_has_tag</code> table reference
     */
    ...
    /**
     * Create a <code>live_core.page_has_tag</code> table reference
     */
    public PageHasTag() {
