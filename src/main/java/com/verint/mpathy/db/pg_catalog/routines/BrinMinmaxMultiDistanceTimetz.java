...
public class BrinMinmaxMultiDistanceTimetz extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.brin_minmax_multi_distance_timetz.RETURN_VALUE</code>.
     */
     ...
     */
    public BrinMinmaxMultiDistanceTimetz() {
        super("brin_minmax_multi_distance_timetz", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
