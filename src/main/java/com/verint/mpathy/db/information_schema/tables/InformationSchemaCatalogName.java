...
import com.verint.mpathy.db.information_schema.tables.records.InformationSchemaCatalogNameRecord;
...
public class InformationSchemaCatalogName extends TableImpl<InformationSchemaCatalogNameRecord> {
     ...
     */
    public final TableField<InformationSchemaCatalogNameRecord, String> CATALOG_NAME = createField(DSL.name("catalog_name"), com.verint.mpathy.db.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");
    ...
    private InformationSchemaCatalogName(Name alias, Table<InformationSchemaCatalogNameRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view \"information_schema_catalog_name\" as  SELECT (current_database())::information_schema.sql_identifier AS catalog_name;"));
    }
