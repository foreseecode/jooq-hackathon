...
public class PgStatGetBackendXactStart extends AbstractRoutine<OffsetDateTime> {
    ...
    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_backend_xact_start.RETURN_VALUE</code>.
     */
    ...
    public PgStatGetBackendXactStart() {
        super("pg_stat_get_backend_xact_start", PgCatalog.PG_CATALOG, SQLDataType.TIMESTAMPWITHTIMEZONE(6));
