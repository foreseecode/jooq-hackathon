...
public class PgStatUserTablesRecord extends TableRecordImpl<PgStatUserTablesRecord> {
     ...
     */
    public PgStatUserTablesRecord(Long relid, String schemaname, String relname, Long seqScan, Long seqTupRead, Long idxScan, Long idxTupFetch, Long nTupIns, Long nTupUpd, Long nTupDel, Long nTupHotUpd, Long nLiveTup, Long nDeadTup, Long nModSinceAnalyze, Long nInsSinceVacuum, OffsetDateTime lastVacuum, OffsetDateTime lastAutovacuum, OffsetDateTime lastAnalyze, OffsetDateTime lastAutoanalyze, Long vacuumCount, Long autovacuumCount, Long analyzeCount, Long autoanalyzeCount) {
        super(PgStatUserTables.PG_STAT_USER_TABLES);
