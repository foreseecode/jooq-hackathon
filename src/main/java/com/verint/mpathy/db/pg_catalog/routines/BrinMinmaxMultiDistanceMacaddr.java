...
public class BrinMinmaxMultiDistanceMacaddr extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.brin_minmax_multi_distance_macaddr.RETURN_VALUE</code>.
     */
     ...
     */
    public BrinMinmaxMultiDistanceMacaddr() {
        super("brin_minmax_multi_distance_macaddr", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
