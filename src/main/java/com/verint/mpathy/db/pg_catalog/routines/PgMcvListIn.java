...
public class PgMcvListIn extends AbstractRoutine<Object> {
     ...
     */
    public PgMcvListIn() {
        super("pg_mcv_list_in", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_mcv_list\""));
