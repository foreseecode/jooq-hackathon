...
public class TimestampSupport extends AbstractRoutine<Object> {
     ...
     */
    public TimestampSupport() {
        super("timestamp_support", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
