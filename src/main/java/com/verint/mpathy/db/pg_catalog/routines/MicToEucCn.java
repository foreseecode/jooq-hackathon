...
public class MicToEucCn extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.mic_to_euc_cn.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.mic_to_euc_cn._6</code>.
     */
     ...
     */
    public MicToEucCn() {
        super("mic_to_euc_cn", PgCatalog.PG_CATALOG, SQLDataType.INTEGER);
