...
public class BrinMinmaxMultiDistanceTimestamp extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.brin_minmax_multi_distance_timestamp.RETURN_VALUE</code>.
     */
     ...
     */
    public BrinMinmaxMultiDistanceTimestamp() {
        super("brin_minmax_multi_distance_timestamp", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
