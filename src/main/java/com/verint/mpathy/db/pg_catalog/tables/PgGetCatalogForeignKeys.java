...
public class PgGetCatalogForeignKeys extends TableImpl<PgGetCatalogForeignKeysRecord> {
     ...
     */
    public final TableField<PgGetCatalogForeignKeysRecord, String[]> FKCOLS = createField(DSL.name("fkcols"), SQLDataType.CLOB.getArrayDataType(), this, "");
     ...
     */
    public final TableField<PgGetCatalogForeignKeysRecord, String[]> PKCOLS = createField(DSL.name("pkcols"), SQLDataType.CLOB.getArrayDataType(), this, "");
