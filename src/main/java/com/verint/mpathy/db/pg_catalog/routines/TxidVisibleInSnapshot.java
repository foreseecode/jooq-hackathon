...
public class TxidVisibleInSnapshot extends AbstractRoutine<Boolean> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> _2 = Internal.createParameter("_2", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"txid_snapshot\""), false, true);

    /**
     * Create a new routine call instance
     */
    public TxidVisibleInSnapshot() {
        super("txid_visible_in_snapshot", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN);
