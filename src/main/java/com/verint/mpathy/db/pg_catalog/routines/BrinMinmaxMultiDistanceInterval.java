...
public class BrinMinmaxMultiDistanceInterval extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.brin_minmax_multi_distance_interval.RETURN_VALUE</code>.
     */
     ...
     */
    public BrinMinmaxMultiDistanceInterval() {
        super("brin_minmax_multi_distance_interval", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
