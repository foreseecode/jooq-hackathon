...
import com.verint.mpathy.db.live_data.tables.records.SessionHasPagenameRecord;
...
public class SessionHasPagename extends TableImpl<SessionHasPagenameRecord> {
    ...
    /**
     * The reference instance of <code>live_data.session_has_pagename</code>
     */
    ...
    /**
     * The column <code>live_data.session_has_pagename.idsite</code>.
     */
    public final TableField<SessionHasPagenameRecord, Integer> IDSITE = createField(DSL.name("idsite"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>live_data.session_has_pagename.idsession</code>.
     */
    ...
    /**
     * The column <code>live_data.session_has_pagename.idpage_name</code>.
     */
    ...
    /**
     * The column <code>live_data.session_has_pagename.occurrence</code>.
     */
    ...
    /**
     * Create an aliased <code>live_data.session_has_pagename</code> table
     * reference
     */
    ...
    /**
     * Create a <code>live_data.session_has_pagename</code> table reference
     */
