...
import com.verint.mpathy.db.live_core.tables.records.Cp_3338PageimpressionRecord;
...
public class Cp_3338Pageimpression extends TableImpl<Cp_3338PageimpressionRecord> {
    ...
    /**
     * The reference instance of <code>live_core.cp_3338_pageimpression</code>
     */
    ...
    /**
     * The column <code>live_core.cp_3338_pageimpression.idpage</code>.
     */
    public final TableField<Cp_3338PageimpressionRecord, BigDecimal> IDPAGE = createField(DSL.name("idpage"), SQLDataType.NUMERIC, this, "");

    /**
     * The column <code>live_core.cp_3338_pageimpression.idcp</code>.
     */
    public final TableField<Cp_3338PageimpressionRecord, Long> IDCP = createField(DSL.name("idcp"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>live_core.cp_3338_pageimpression.idvalue</code>.
     */
    ...
    private Cp_3338Pageimpression(Name alias, Table<Cp_3338PageimpressionRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"cp_3338_pageimpression\" as  SELECT cp_3338_pageimpression.idpage,\n    cp_3338_pageimpression.idcp,\n    cp_3338_pageimpression.idvalue\n   FROM live.cp_3338_pageimpression;"));
    }

    /**
     * Create an aliased <code>live_core.cp_3338_pageimpression</code> table
     * reference
     */
    ...
    /**
     * Create a <code>live_core.cp_3338_pageimpression</code> table reference
     */
