...
import com.verint.mpathy.db.live_core.tables.records.DataBaseTestRecord;
...
public class DataBaseTest extends TableImpl<DataBaseTestRecord> {
    ...
    /**
     * The reference instance of <code>live_core.data_base_test</code>
     */
    ...
    private DataBaseTest(Name alias, Table<DataBaseTestRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"data_base_test\" as  SELECT data_base_test.id,\n    data_base_test.test_column,\n    data_base_test.another_test_column\n   FROM live.data_base_test;"));
    }

    /**
     * Create an aliased <code>live_core.data_base_test</code> table reference
     */
    ...
    /**
     * Create a <code>live_core.data_base_test</code> table reference
     */
    public DataBaseTest() {
