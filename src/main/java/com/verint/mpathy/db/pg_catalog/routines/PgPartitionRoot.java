...
public class PgPartitionRoot extends AbstractRoutine<Object> {
     ...
     */
    public PgPartitionRoot() {
        super("pg_partition_root", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"regclass\""));
