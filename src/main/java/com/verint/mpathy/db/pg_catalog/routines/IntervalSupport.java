...
public class IntervalSupport extends AbstractRoutine<Object> {
    ...
    public IntervalSupport() {
        super("interval_support", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
