...
import com.verint.mpathy.db.live_core.tables.records.SessionHasPagenameRecord;
...
public class SessionHasPagename extends TableImpl<SessionHasPagenameRecord> {
    ...
    /**
     * The reference instance of <code>live_core.session_has_pagename</code>
     */
    ...
    /**
     * The column <code>live_core.session_has_pagename.idsite</code>.
     */
    public final TableField<SessionHasPagenameRecord, Integer> IDSITE = createField(DSL.name("idsite"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>live_core.session_has_pagename.idsession</code>.
     */
    public final TableField<SessionHasPagenameRecord, BigDecimal> IDSESSION = createField(DSL.name("idsession"), SQLDataType.NUMERIC, this, "");

    /**
     * The column <code>live_core.session_has_pagename.idpage_name</code>.
     */
    public final TableField<SessionHasPagenameRecord, Long> IDPAGE_NAME = createField(DSL.name("idpage_name"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>live_core.session_has_pagename.occurrence</code>.
     */
    ...
    private SessionHasPagename(Name alias, Table<SessionHasPagenameRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"session_has_pagename\" as  SELECT session_has_pagename.idsite,\n    session_has_pagename.idsession,\n    session_has_pagename.idpage_name,\n    session_has_pagename.occurrence\n   FROM live.session_has_pagename;"));
    }

    /**
     * Create an aliased <code>live_core.session_has_pagename</code> table
     * reference
     */
    ...
    /**
     * Create a <code>live_core.session_has_pagename</code> table reference
     */
