...
public class PgGetStatisticsobjdefExpressions extends AbstractRoutine<String[]> {
     ...
     */
    public PgGetStatisticsobjdefExpressions() {
        super("pg_get_statisticsobjdef_expressions", PgCatalog.PG_CATALOG, SQLDataType.CLOB.getArrayDataType());
