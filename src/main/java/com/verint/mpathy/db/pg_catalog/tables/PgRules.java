...
import com.verint.mpathy.db.pg_catalog.tables.records.PgRulesRecord;
...
public class PgRules extends TableImpl<PgRulesRecord> {
    ...
    private PgRules(Name alias, Table<PgRulesRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view \"pg_rules\" as  SELECT n.nspname AS schemaname,\n    c.relname AS tablename,\n    r.rulename,\n    pg_get_ruledef(r.oid) AS definition\n   FROM ((pg_rewrite r\n     JOIN pg_class c ON ((c.oid = r.ev_class)))\n     LEFT JOIN pg_namespace n ON ((n.oid = c.relnamespace)))\n  WHERE (r.rulename <> '_RETURN'::name);"));
    }
