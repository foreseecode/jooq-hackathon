...
public class BrinMinmaxMultiAddValue extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.brin_minmax_multi_add_value.RETURN_VALUE</code>.
     */
     ...
     */
    public BrinMinmaxMultiAddValue() {
        super("brin_minmax_multi_add_value", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN);
