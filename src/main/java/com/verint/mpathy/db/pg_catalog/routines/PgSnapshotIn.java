...
public class PgSnapshotIn extends AbstractRoutine<Object> {
     ...
     */
    public PgSnapshotIn() {
        super("pg_snapshot_in", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_snapshot\""));
