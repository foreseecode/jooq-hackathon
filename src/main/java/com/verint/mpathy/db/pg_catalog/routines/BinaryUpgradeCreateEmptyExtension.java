...
public class BinaryUpgradeCreateEmptyExtension extends AbstractRoutine<java.lang.Void> {
     ...
     */
    public static final Parameter<Long[]> _5 = Internal.createParameter("_5", SQLDataType.BIGINT.getArrayDataType(), false, true);

    /**
     * The parameter
     * <code>pg_catalog.binary_upgrade_create_empty_extension._6</code>.
     */
    public static final Parameter<String[]> _6 = Internal.createParameter("_6", SQLDataType.CLOB.getArrayDataType(), false, true);

    /**
     * The parameter
     * <code>pg_catalog.binary_upgrade_create_empty_extension._7</code>.
     */
    public static final Parameter<String[]> _7 = Internal.createParameter("_7", SQLDataType.CLOB.getArrayDataType(), false, true);
