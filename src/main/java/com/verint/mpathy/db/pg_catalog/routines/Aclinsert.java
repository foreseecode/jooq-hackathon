...
public class Aclinsert extends AbstractRoutine<String[]> {
     ...
     */
    public static final Parameter<String[]> _1 = Internal.createParameter("_1", SQLDataType.VARCHAR.getArrayDataType(), false, true);
     ...
     */
    public Aclinsert() {
        super("aclinsert", PgCatalog.PG_CATALOG, SQLDataType.VARCHAR.getArrayDataType());
