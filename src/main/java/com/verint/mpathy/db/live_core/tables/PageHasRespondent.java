...
import com.verint.mpathy.db.live_core.tables.records.PageHasRespondentRecord;
...
public class PageHasRespondent extends TableImpl<PageHasRespondentRecord> {
    ...
    /**
     * The reference instance of <code>live_core.page_has_respondent</code>
     */
     ...
     */
    public final TableField<PageHasRespondentRecord, Long> IDPAGE_HAS_RESPONDENT = createField(DSL.name("idpage_has_respondent"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>live_core.page_has_respondent.idpage</code>.
     */
    public final TableField<PageHasRespondentRecord, BigDecimal> IDPAGE = createField(DSL.name("idpage"), SQLDataType.NUMERIC, this, "");

    /**
     * The column <code>live_core.page_has_respondent.idsite</code>.
     */
    public final TableField<PageHasRespondentRecord, Integer> IDSITE = createField(DSL.name("idsite"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>live_core.page_has_respondent.idsession</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent.idvisitor</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent.idrespondent</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent.idclient</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent.idmodelinstance</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent.respondentdate</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent.respondenttype</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent.deleted_at</code>.
     */
    public final TableField<PageHasRespondentRecord, LocalTime> DELETED_AT = createField(DSL.name("deleted_at"), SQLDataType.LOCALTIME(6), this, "");
    ...
    private PageHasRespondent(Name alias, Table<PageHasRespondentRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"page_has_respondent\" as  SELECT page_has_respondent.idpage_has_respondent,\n    page_has_respondent.idpage,\n    page_has_respondent.idsite,\n    page_has_respondent.idsession,\n    page_has_respondent.idvisitor,\n    page_has_respondent.idrespondent,\n    page_has_respondent.idclient,\n    page_has_respondent.idmodelinstance,\n    page_has_respondent.respondentdate,\n    page_has_respondent.respondenttype,\n    page_has_respondent.deleted_at\n   FROM live.page_has_respondent;"));
    }

    /**
     * Create an aliased <code>live_core.page_has_respondent</code> table
     * reference
     */
    ...
    /**
     * Create a <code>live_core.page_has_respondent</code> table reference
     */
