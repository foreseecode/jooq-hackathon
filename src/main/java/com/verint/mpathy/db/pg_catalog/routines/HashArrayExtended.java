...
public class HashArrayExtended extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.hash_array_extended.RETURN_VALUE</code>.
     */
     ...
     */
    public HashArrayExtended() {
        super("hash_array_extended", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
