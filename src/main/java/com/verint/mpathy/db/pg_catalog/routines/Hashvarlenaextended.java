...
public class Hashvarlenaextended extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.hashvarlenaextended.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.hashvarlenaextended._2</code>.
     */
     ...
     */
    public Hashvarlenaextended() {
        super("hashvarlenaextended", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
