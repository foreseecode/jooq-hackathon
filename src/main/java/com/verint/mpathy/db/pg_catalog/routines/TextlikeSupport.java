...
public class TextlikeSupport extends AbstractRoutine<Object> {
     ...
     */
    public TextlikeSupport() {
        super("textlike_support", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
