...
import com.verint.mpathy.db.live_core.tables.records.MapVisibleRecord;
...
public class MapVisible extends TableImpl<MapVisibleRecord> {
    ...
    /**
     * The reference instance of <code>live_core.map_visible</code>
     */
    ...
    private MapVisible(Name alias, Table<MapVisibleRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"map_visible\" as  SELECT map_visible.idpage,\n    map_visible.idsession,\n    map_visible.idsite,\n    map_visible.viewport,\n    map_visible.\"time\",\n    map_visible.x1,\n    map_visible.y1,\n    map_visible.x2,\n    map_visible.y2\n   FROM live.map_visible;"));
    }

    /**
     * Create an aliased <code>live_core.map_visible</code> table reference
     */
    ...
    /**
     * Create a <code>live_core.map_visible</code> table reference
     */
    public MapVisible() {
