...
public class PgStatGetXactTuplesReturned extends AbstractRoutine<Long> {
    ...
    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_xact_tuples_returned.RETURN_VALUE</code>.
     */
    public static final Parameter<Long> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BIGINT, false, false);

    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_xact_tuples_returned._1</code>.
     */
    ...
    public PgStatGetXactTuplesReturned() {
        super("pg_stat_get_xact_tuples_returned", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
