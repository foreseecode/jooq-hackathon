...
public class Atanh extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.atanh.RETURN_VALUE</code>.
     */
    public static final Parameter<Double> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.DOUBLE, false, false);

    /**
     * The parameter <code>pg_catalog.atanh._1</code>.
     */
     ...
     */
    public Atanh() {
        super("atanh", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
