...
public class MultirangeIn extends AbstractRoutine<Object> {
    ...
    /**
     * The parameter <code>pg_catalog.multirange_in._2</code>.
     */
    public static final Parameter<Long> _2 = Internal.createParameter("_2", SQLDataType.BIGINT, false, true);

    /**
     * The parameter <code>pg_catalog.multirange_in._3</code>.
     */
     ...
     */
    public MultirangeIn() {
        super("multirange_in", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anymultirange\""));
