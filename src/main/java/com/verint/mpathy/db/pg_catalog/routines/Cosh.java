...
public class Cosh extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.cosh.RETURN_VALUE</code>.
     */
    public static final Parameter<Double> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.DOUBLE, false, false);

    /**
     * The parameter <code>pg_catalog.cosh._1</code>.
     */
     ...
     */
    public Cosh() {
        super("cosh", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
