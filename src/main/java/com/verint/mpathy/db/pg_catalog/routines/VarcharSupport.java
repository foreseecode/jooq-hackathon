...
public class VarcharSupport extends AbstractRoutine<Object> {
     ...
     */
    public VarcharSupport() {
        super("varchar_support", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
