...
import com.verint.mpathy.db.live_core.tables.records.StruggleIndicatorErrorPageRecord;
...
public class StruggleIndicatorErrorPage extends TableImpl<StruggleIndicatorErrorPageRecord> {
     ...
     * <code>live_core.struggle_indicator_error_page</code>
     */
     ...
     */
    public final TableField<StruggleIndicatorErrorPageRecord, Long> IDSTRUGGLE_INDICATOR_ERROR_PAGE = createField(DSL.name("idstruggle_indicator_error_page"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>live_core.struggle_indicator_error_page.idpage</code>.
     */
    public final TableField<StruggleIndicatorErrorPageRecord, BigDecimal> IDPAGE = createField(DSL.name("idpage"), SQLDataType.NUMERIC, this, "");

    /**
     * The column <code>live_core.struggle_indicator_error_page.value</code>.
     */
    public final TableField<StruggleIndicatorErrorPageRecord, Short> VALUE = createField(DSL.name("value"), SQLDataType.SMALLINT, this, "");
    ...
    private StruggleIndicatorErrorPage(Name alias, Table<StruggleIndicatorErrorPageRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"struggle_indicator_error_page\" as  SELECT struggle_indicator_error_page.idstruggle_indicator_error_page,\n    struggle_indicator_error_page.idpage,\n    struggle_indicator_error_page.value\n   FROM live.struggle_indicator_error_page;"));
    }

    /**
     * Create an aliased <code>live_core.struggle_indicator_error_page</code>
     * table reference
     */
    ...
    /**
     * Create a <code>live_core.struggle_indicator_error_page</code> table
     * reference
     */
