...
public class SjisToEucJp extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.sjis_to_euc_jp.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.sjis_to_euc_jp._6</code>.
     */
     ...
     */
    public SjisToEucJp() {
        super("sjis_to_euc_jp", PgCatalog.PG_CATALOG, SQLDataType.INTEGER);
