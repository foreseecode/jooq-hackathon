...
import com.verint.mpathy.db.live_core.tables.records.PageHasResourceRecord;
...
public class PageHasResource extends TableImpl<PageHasResourceRecord> {
    ...
    /**
     * The reference instance of <code>live_core.page_has_resource</code>
     */
    ...
    /**
     * The column <code>live_core.page_has_resource.idpage</code>.
     */
    public final TableField<PageHasResourceRecord, BigDecimal> IDPAGE = createField(DSL.name("idpage"), SQLDataType.NUMERIC, this, "");

    /**
     * The column <code>live_core.page_has_resource.idres</code>.
     */
    public final TableField<PageHasResourceRecord, BigDecimal> IDRES = createField(DSL.name("idres"), SQLDataType.NUMERIC, this, "");
    ...
    private PageHasResource(Name alias, Table<PageHasResourceRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"page_has_resource\" as  SELECT page_has_resource.idpage,\n    page_has_resource.idres\n   FROM live.page_has_resource;"));
    }

    /**
     * Create an aliased <code>live_core.page_has_resource</code> table
     * reference
     */
    ...
    /**
     * Create a <code>live_core.page_has_resource</code> table reference
     */
