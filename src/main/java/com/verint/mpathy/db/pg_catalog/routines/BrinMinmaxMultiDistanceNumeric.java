...
public class BrinMinmaxMultiDistanceNumeric extends AbstractRoutine<Double> {
     ...
     */
    public BrinMinmaxMultiDistanceNumeric() {
        super("brin_minmax_multi_distance_numeric", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
