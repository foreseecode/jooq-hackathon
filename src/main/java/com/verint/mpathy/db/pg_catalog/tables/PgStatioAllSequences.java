...
import com.verint.mpathy.db.pg_catalog.tables.records.PgStatioAllSequencesRecord;
...
public class PgStatioAllSequences extends TableImpl<PgStatioAllSequencesRecord> {
    ...
    private PgStatioAllSequences(Name alias, Table<PgStatioAllSequencesRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view \"pg_statio_all_sequences\" as  SELECT c.oid AS relid,\n    n.nspname AS schemaname,\n    c.relname,\n    (pg_stat_get_blocks_fetched(c.oid) - pg_stat_get_blocks_hit(c.oid)) AS blks_read,\n    pg_stat_get_blocks_hit(c.oid) AS blks_hit\n   FROM (pg_class c\n     LEFT JOIN pg_namespace n ON ((n.oid = c.relnamespace)))\n  WHERE (c.relkind = 'S'::\"char\");"));
    }
