...
public class IntervalHashExtended extends AbstractRoutine<Long> {
     ...
     */
    public IntervalHashExtended() {
        super("interval_hash_extended", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
