...
public class Lcm3 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.lcm.RETURN_VALUE</code>.
     */
     ...
     */
    public Lcm3() {
        super("lcm", PgCatalog.PG_CATALOG, SQLDataType.NUMERIC);
