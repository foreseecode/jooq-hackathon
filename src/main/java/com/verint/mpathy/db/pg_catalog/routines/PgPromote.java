...
public class PgPromote extends AbstractRoutine<Boolean> {
     ...
     */
    public static final Parameter<Boolean> WAIT = Internal.createParameter("wait", SQLDataType.BOOLEAN.defaultValue(DSL.field("true", SQLDataType.BOOLEAN)), true, false);

    /**
     * The parameter <code>pg_catalog.pg_promote.wait_seconds</code>.
     */
    public static final Parameter<Integer> WAIT_SECONDS = Internal.createParameter("wait_seconds", SQLDataType.INTEGER.defaultValue(DSL.field("60", SQLDataType.INTEGER)), true, false);
