...
public class PgStatGetDbConflictStartupDeadlock extends AbstractRoutine<Long> {
    ...
    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_db_conflict_startup_deadlock.RETURN_VALUE</code>.
     */
    public static final Parameter<Long> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BIGINT, false, false);

    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_db_conflict_startup_deadlock._1</code>.
     */
    ...
    public PgStatGetDbConflictStartupDeadlock() {
        super("pg_stat_get_db_conflict_startup_deadlock", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
