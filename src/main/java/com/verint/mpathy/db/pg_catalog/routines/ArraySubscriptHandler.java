...
public class ArraySubscriptHandler extends AbstractRoutine<Object> {
     ...
     */
    public ArraySubscriptHandler() {
        super("array_subscript_handler", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
