...
public class DistPolyc extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.dist_polyc.RETURN_VALUE</code>.
     */
     ...
     */
    public DistPolyc() {
        super("dist_polyc", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
