...
public class MultirangeTypanalyze extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.multirange_typanalyze.RETURN_VALUE</code>.
     */
     ...
     */
    public MultirangeTypanalyze() {
        super("multirange_typanalyze", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN);
