...
import com.verint.mpathy.db.live_core.tables.records.EventTableRecord;
...
public class EventTable extends TableImpl<EventTableRecord> {
    ...
    /**
     * The reference instance of <code>live_core.event_table</code>
     */
    ...
    private EventTable(Name alias, Table<EventTableRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"event_table\" as  SELECT event_table.idevent,\n    event_table.name,\n    event_table.structure,\n    event_table.user_activity,\n    event_table.revision,\n    event_table.deprecated\n   FROM live.event_table;"));
    }

    /**
     * Create an aliased <code>live_core.event_table</code> table reference
     */
    ...
    /**
     * Create a <code>live_core.event_table</code> table reference
     */
    public EventTable() {
