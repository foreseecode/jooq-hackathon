...
public class PgSafeSnapshotBlockingPids extends AbstractRoutine<Integer[]> {
     ...
     */
    public static final Parameter<Integer[]> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.INTEGER.getArrayDataType(), false, false);
    ...
    public PgSafeSnapshotBlockingPids() {
        super("pg_safe_snapshot_blocking_pids", PgCatalog.PG_CATALOG, SQLDataType.INTEGER.getArrayDataType());
