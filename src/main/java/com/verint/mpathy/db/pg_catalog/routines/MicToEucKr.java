...
public class MicToEucKr extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.mic_to_euc_kr.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.mic_to_euc_kr._6</code>.
     */
     ...
     */
    public MicToEucKr() {
        super("mic_to_euc_kr", PgCatalog.PG_CATALOG, SQLDataType.INTEGER);
