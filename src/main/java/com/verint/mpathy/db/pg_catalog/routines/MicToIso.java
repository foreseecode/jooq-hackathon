...
public class MicToIso extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.mic_to_iso.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.mic_to_iso._6</code>.
     */
     ...
     */
    public MicToIso() {
        super("mic_to_iso", PgCatalog.PG_CATALOG, SQLDataType.INTEGER);
