...
public class PgNextoid extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.pg_nextoid.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.pg_nextoid._2</code>.
     */
     ...
     */
    public PgNextoid() {
        super("pg_nextoid", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
