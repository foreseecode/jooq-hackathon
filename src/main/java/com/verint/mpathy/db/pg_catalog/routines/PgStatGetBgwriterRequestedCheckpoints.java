...
public class PgStatGetBgwriterRequestedCheckpoints extends AbstractRoutine<Long> {
    ...
    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_bgwriter_requested_checkpoints.RETURN_VALUE</code>.
     */
    ...
    public PgStatGetBgwriterRequestedCheckpoints() {
        super("pg_stat_get_bgwriter_requested_checkpoints", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
