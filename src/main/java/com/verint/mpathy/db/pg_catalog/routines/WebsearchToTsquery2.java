...
public class WebsearchToTsquery2 extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"tsquery\""), false, false);

    /**
     * The parameter <code>pg_catalog.websearch_to_tsquery._1</code>.
     */
     ...
     */
    public WebsearchToTsquery2() {
        super("websearch_to_tsquery", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"tsquery\""));
