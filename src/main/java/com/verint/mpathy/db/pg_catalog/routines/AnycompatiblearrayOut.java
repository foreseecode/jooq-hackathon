...
public class AnycompatiblearrayOut extends AbstractRoutine<Object> {
     ...
     */
    public AnycompatiblearrayOut() {
        super("anycompatiblearray_out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
