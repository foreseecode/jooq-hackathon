...
public class HashAclitemExtended extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.hash_aclitem_extended.RETURN_VALUE</code>.
     */
     ...
     */
    public HashAclitemExtended() {
        super("hash_aclitem_extended", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
