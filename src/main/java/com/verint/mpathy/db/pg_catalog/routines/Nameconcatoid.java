...
public class Nameconcatoid extends AbstractRoutine<String> {
     ...
     */
    public Nameconcatoid() {
        super("nameconcatoid", PgCatalog.PG_CATALOG, SQLDataType.VARCHAR);
