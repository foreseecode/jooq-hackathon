...
public class RawArraySubscriptHandler extends AbstractRoutine<Object> {
     ...
     */
    public RawArraySubscriptHandler() {
        super("raw_array_subscript_handler", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
