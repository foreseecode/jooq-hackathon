...
public class JsonbSubscriptHandler extends AbstractRoutine<Object> {
     ...
     */
    public JsonbSubscriptHandler() {
        super("jsonb_subscript_handler", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
