...
import com.verint.mpathy.db.live_core.tables.records.Cp_1SessionRecord;
...
public class Cp_1Session extends TableImpl<Cp_1SessionRecord> {
    ...
    /**
     * The reference instance of <code>live_core.cp_1_session</code>
     */
    ...
    private Cp_1Session(Name alias, Table<Cp_1SessionRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"cp_1_session\" as  SELECT cp_1_session.idsession,\n    cp_1_session.idcp,\n    cp_1_session.idvalue\n   FROM live.cp_1_session;"));
    }

    /**
     * Create an aliased <code>live_core.cp_1_session</code> table reference
     */
    ...
    /**
     * Create a <code>live_core.cp_1_session</code> table reference
     */
    public Cp_1Session() {
