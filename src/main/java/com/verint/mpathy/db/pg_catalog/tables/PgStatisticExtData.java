...
public class PgStatisticExtData extends TableImpl<PgStatisticExtDataRecord> {
     ...
     */
    public final TableField<PgStatisticExtDataRecord, PgStatisticRecord[]> STXDEXPR = createField(DSL.name("stxdexpr"), com.verint.mpathy.db.pg_catalog.tables.PgStatistic.PG_STATISTIC.getDataType().getArrayDataType(), this, "");
