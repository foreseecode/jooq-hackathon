...
public class AnycompatiblearraySend extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.anycompatiblearray_send.RETURN_VALUE</code>.
     */
     ...
     */
    public AnycompatiblearraySend() {
        super("anycompatiblearray_send", PgCatalog.PG_CATALOG, SQLDataType.BLOB);
