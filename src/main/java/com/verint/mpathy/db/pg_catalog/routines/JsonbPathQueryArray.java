...
public class JsonbPathQueryArray extends AbstractRoutine<JSONB> {
     ...
     */
    public JsonbPathQueryArray() {
        super("jsonb_path_query_array", PgCatalog.PG_CATALOG, SQLDataType.JSONB);
