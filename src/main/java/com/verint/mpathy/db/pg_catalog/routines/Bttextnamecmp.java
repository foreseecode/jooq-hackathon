...
public class Bttextnamecmp extends AbstractRoutine<Integer> {
     ...
     */
    public Bttextnamecmp() {
        super("bttextnamecmp", PgCatalog.PG_CATALOG, SQLDataType.INTEGER);
