...
import com.verint.mpathy.db.live_core.tables.records.Cp_2PageimpressionRecord;
...
public class Cp_2Pageimpression extends TableImpl<Cp_2PageimpressionRecord> {
    ...
    /**
     * The reference instance of <code>live_core.cp_2_pageimpression</code>
     */
    ...
    private Cp_2Pageimpression(Name alias, Table<Cp_2PageimpressionRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"cp_2_pageimpression\" as  SELECT cp_2_pageimpression.idpage,\n    cp_2_pageimpression.idcp,\n    cp_2_pageimpression.idvalue\n   FROM live.cp_2_pageimpression;"));
    }

    /**
     * Create an aliased <code>live_core.cp_2_pageimpression</code> table
     * reference
     */
    ...
    /**
     * Create a <code>live_core.cp_2_pageimpression</code> table reference
     */
