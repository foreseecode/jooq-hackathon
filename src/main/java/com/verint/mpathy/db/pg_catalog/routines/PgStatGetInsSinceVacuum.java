...
public class PgStatGetInsSinceVacuum extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_ins_since_vacuum.RETURN_VALUE</code>.
     */
    public static final Parameter<Long> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>pg_catalog.pg_stat_get_ins_since_vacuum._1</code>.
     */
     ...
     */
    public PgStatGetInsSinceVacuum() {
        super("pg_stat_get_ins_since_vacuum", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
