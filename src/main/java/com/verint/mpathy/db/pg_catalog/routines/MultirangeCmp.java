...
public class MultirangeCmp extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.multirange_cmp.RETURN_VALUE</code>.
     */
     ...
     */
    public MultirangeCmp() {
        super("multirange_cmp", PgCatalog.PG_CATALOG, SQLDataType.INTEGER);
