...
public class GinTsqueryConsistent2 extends AbstractRoutine<Boolean> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> _3 = Internal.createParameter("_3", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"tsvector\""), false, true);
    ...
    public GinTsqueryConsistent2() {
        super("gin_tsquery_consistent", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN);
