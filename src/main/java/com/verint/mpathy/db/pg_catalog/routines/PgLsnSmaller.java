...
public class PgLsnSmaller extends AbstractRoutine<Object> {
     ...
     */
    public PgLsnSmaller() {
        super("pg_lsn_smaller", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_lsn\""));
