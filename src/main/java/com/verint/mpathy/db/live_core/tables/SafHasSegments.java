...
import com.verint.mpathy.db.live_core.tables.records.SafHasSegmentsRecord;
...
public class SafHasSegments extends TableImpl<SafHasSegmentsRecord> {
    ...
    /**
     * The reference instance of <code>live_core.saf_has_segments</code>
     */
    ...
    /**
     * The column <code>live_core.saf_has_segments.idfile</code>.
     */
    public final TableField<SafHasSegmentsRecord, BigDecimal> IDFILE = createField(DSL.name("idfile"), SQLDataType.NUMERIC, this, "");

    /**
     * The column <code>live_core.saf_has_segments.idsegment_saf</code>.
     */
    public final TableField<SafHasSegmentsRecord, String> IDSEGMENT_SAF = createField(DSL.name("idsegment_saf"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>live_core.saf_has_segments.name</code>.
     */
    public final TableField<SafHasSegmentsRecord, String> NAME = createField(DSL.name("name"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>live_core.saf_has_segments.type</code>.
     */
    public final TableField<SafHasSegmentsRecord, String> TYPE = createField(DSL.name("type"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>live_core.saf_has_segments.scope</code>.
     */
    public final TableField<SafHasSegmentsRecord, String> SCOPE = createField(DSL.name("scope"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>live_core.saf_has_segments.definition</code>.
     */
    public final TableField<SafHasSegmentsRecord, String> DEFINITION = createField(DSL.name("definition"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>live_core.saf_has_segments.created</code>.
     */
    public final TableField<SafHasSegmentsRecord, LocalTime> CREATED = createField(DSL.name("created"), SQLDataType.LOCALTIME(6), this, "");

    /**
     * The column <code>live_core.saf_has_segments.modified</code>.
     */
    ...
    /**
     * The column <code>live_core.saf_has_segments.idfilter</code>.
     */
    ...
    private SafHasSegments(Name alias, Table<SafHasSegmentsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"saf_has_segments\" as  SELECT saf_has_segments.idfile,\n    saf_has_segments.idsegment_saf,\n    saf_has_segments.name,\n    saf_has_segments.type,\n    saf_has_segments.scope,\n    saf_has_segments.definition,\n    saf_has_segments.created,\n    saf_has_segments.modified,\n    saf_has_segments.idfilter\n   FROM live.saf_has_segments;"));
    }

    /**
     * Create an aliased <code>live_core.saf_has_segments</code> table reference
     */
    ...
    /**
     * Create a <code>live_core.saf_has_segments</code> table reference
     */
