...
public class PgStatGetDbActiveTime extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_db_active_time.RETURN_VALUE</code>.
     */
    public static final Parameter<Double> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.DOUBLE, false, false);

    /**
     * The parameter <code>pg_catalog.pg_stat_get_db_active_time._1</code>.
     */
     ...
     */
    public PgStatGetDbActiveTime() {
        super("pg_stat_get_db_active_time", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
