...
import com.verint.mpathy.db.live.tables.records.DebugClientRecord;
...
public class DebugClient extends TableImpl<DebugClientRecord> {
    ...
    /**
     * The reference instance of <code>live.debug_client</code>
     */
    ...
    /**
     * The column <code>live.debug_client.idpage</code>.
     */
    public final TableField<DebugClientRecord, BigDecimal> IDPAGE = createField(DSL.name("idpage"), SQLDataType.NUMERIC.nullable(false), this, "");

    /**
     * The column <code>live.debug_client.idsite</code>.
     */
    public final TableField<DebugClientRecord, Long> IDSITE = createField(DSL.name("idsite"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>live.debug_client.idsession</code>.
     */
    public final TableField<DebugClientRecord, BigDecimal> IDSESSION = createField(DSL.name("idsession"), SQLDataType.NUMERIC, this, "");

    /**
     * The column <code>live.debug_client.message</code>.
     */
    ...
    /**
     * Create an aliased <code>live.debug_client</code> table reference
     */
    ...
    /**
     * Create a <code>live.debug_client</code> table reference
     */
    public DebugClient() {
