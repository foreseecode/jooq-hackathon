...
public class EucKrToMic extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.euc_kr_to_mic.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.euc_kr_to_mic._6</code>.
     */
     ...
     */
    public EucKrToMic() {
        super("euc_kr_to_mic", PgCatalog.PG_CATALOG, SQLDataType.INTEGER);
