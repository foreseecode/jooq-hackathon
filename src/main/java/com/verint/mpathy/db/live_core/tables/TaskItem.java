...
import com.verint.mpathy.db.live_core.tables.records.TaskItemRecord;
...
public class TaskItem extends TableImpl<TaskItemRecord> {
    ...
    /**
     * The reference instance of <code>live_core.task_item</code>
     */
    ...
    /**
     * The column <code>live_core.task_item.idtaskitem</code>.
     */
    public final TableField<TaskItemRecord, Long> IDTASKITEM = createField(DSL.name("idtaskitem"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>live_core.task_item.idtask</code>.
     */
    public final TableField<TaskItemRecord, Long> IDTASK = createField(DSL.name("idtask"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>live_core.task_item.name</code>.
     */
    public final TableField<TaskItemRecord, String> NAME = createField(DSL.name("name"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>live_core.task_item.sequence</code>.
     */
    public final TableField<TaskItemRecord, Long> SEQUENCE = createField(DSL.name("sequence"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>live_core.task_item.immediate_successor</code>.
     */
    ...
    private TaskItem(Name alias, Table<TaskItemRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"task_item\" as  SELECT task_item.idtaskitem,\n    task_item.idtask,\n    task_item.name,\n    task_item.sequence,\n    task_item.immediate_successor,\n    task_item.allow_repeat,\n    task_item.url,\n    task_item.url_regexp,\n    task_item.pagename,\n    task_item.pagename_regexp,\n    task_item.event,\n    task_item.gui_schema\n   FROM live.task_item;"));
    }

    /**
     * Create an aliased <code>live_core.task_item</code> table reference
     */
    ...
    /**
     * Create a <code>live_core.task_item</code> table reference
     */
    public TaskItem() {
