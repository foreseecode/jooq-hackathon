...
public class BrinMinmaxMultiDistanceUuid extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.brin_minmax_multi_distance_uuid.RETURN_VALUE</code>.
     */
     ...
     */
    public BrinMinmaxMultiDistanceUuid() {
        super("brin_minmax_multi_distance_uuid", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
