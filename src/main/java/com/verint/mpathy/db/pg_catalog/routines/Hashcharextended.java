...
public class Hashcharextended extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.hashcharextended.RETURN_VALUE</code>.
     */
    public static final Parameter<Long> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>pg_catalog.hashcharextended._1</code>.
     */
    public static final Parameter<String> _1 = Internal.createParameter("_1", SQLDataType.CHAR, false, true);

    /**
     * The parameter <code>pg_catalog.hashcharextended._2</code>.
     */
     ...
     */
    public Hashcharextended() {
        super("hashcharextended", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
