...
import com.verint.mpathy.db.live.tables.records.SafSegmentHasPageRecord;
...
public class SafSegmentHasPage extends TableImpl<SafSegmentHasPageRecord> {
    ...
    /**
     * The reference instance of <code>live.saf_segment_has_page</code>
     */
    ...
    /**
     * The column <code>live.saf_segment_has_page.idpage</code>.
     */
    public final TableField<SafSegmentHasPageRecord, BigDecimal> IDPAGE = createField(DSL.name("idpage"), SQLDataType.NUMERIC.nullable(false), this, "");

    /**
     * The column <code>live.saf_segment_has_page.idsite</code>.
     */
    public final TableField<SafSegmentHasPageRecord, Long> IDSITE = createField(DSL.name("idsite"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>live.saf_segment_has_page.idfilter</code>.
     */
    public final TableField<SafSegmentHasPageRecord, BigDecimal> IDFILTER = createField(DSL.name("idfilter"), SQLDataType.NUMERIC.nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>live.saf_segment_has_page</code> table reference
     */
    ...
    /**
     * Create a <code>live.saf_segment_has_page</code> table reference
     */
