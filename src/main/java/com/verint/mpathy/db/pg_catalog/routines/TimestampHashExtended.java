...
public class TimestampHashExtended extends AbstractRoutine<Long> {
     ...
     */
    public TimestampHashExtended() {
        super("timestamp_hash_extended", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
