...
public class Hashfloat8extended extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.hashfloat8extended.RETURN_VALUE</code>.
     */
     ...
     */
    public Hashfloat8extended() {
        super("hashfloat8extended", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
