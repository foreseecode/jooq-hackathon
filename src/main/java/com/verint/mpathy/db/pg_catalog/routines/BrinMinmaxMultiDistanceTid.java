...
public class BrinMinmaxMultiDistanceTid extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.brin_minmax_multi_distance_tid.RETURN_VALUE</code>.
     */
     ...
     */
    public BrinMinmaxMultiDistanceTid() {
        super("brin_minmax_multi_distance_tid", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
