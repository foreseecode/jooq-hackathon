...
import com.verint.mpathy.db.live_core.tables.records.PageHasRespondentProdRecord;
...
public class PageHasRespondentProd extends TableImpl<PageHasRespondentProdRecord> {
    ...
    /**
     * The reference instance of <code>live_core.page_has_respondent_prod</code>
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.idpage</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.idsite1</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.idsession1</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.idvisitor1</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.idrespondent</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.idclient</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.deleted_at</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.idsession2</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.idsite2</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.idvisitor2</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.idurl</code>.
     */
    public final TableField<PageHasRespondentProdRecord, Long> IDURL = createField(DSL.name("idurl"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>live_core.page_has_respondent_prod.idreferer</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.iduseragent</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.date</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.updated_at</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.length_active</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.length_loaded</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.locale</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.flashver</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.num_pi</code>.
     */
    public final TableField<PageHasRespondentProdRecord, Long> NUM_PI = createField(DSL.name("num_pi"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>live_core.page_has_respondent_prod.imported</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.successor</code>.
     */
    ...
    /**
     * The column <code>live_core.page_has_respondent_prod.idbucket</code>.
     */
    ...
    private PageHasRespondentProd(Name alias, Table<PageHasRespondentProdRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"page_has_respondent_prod\" as  SELECT page_has_respondent_prod.idpage_has_respondent,\n    page_has_respondent_prod.idpage,\n    page_has_respondent_prod.idsite1,\n    page_has_respondent_prod.idsession1,\n    page_has_respondent_prod.idvisitor1,\n    page_has_respondent_prod.idrespondent,\n    page_has_respondent_prod.idclient,\n    page_has_respondent_prod.idmodelinstance,\n    page_has_respondent_prod.respondentdate,\n    page_has_respondent_prod.respondenttype,\n    page_has_respondent_prod.deleted_at,\n    page_has_respondent_prod.idsession2,\n    page_has_respondent_prod.idsite2,\n    page_has_respondent_prod.idvisitor2,\n    page_has_respondent_prod.idurl,\n    page_has_respondent_prod.idreferer,\n    page_has_respondent_prod.iduseragent,\n    page_has_respondent_prod.date,\n    page_has_respondent_prod.updated_at,\n    page_has_respondent_prod.length_active,\n    page_has_respondent_prod.length_visible,\n    page_has_respondent_prod.length_loaded,\n    page_has_respondent_prod.locale,\n    page_has_respondent_prod.mpathy_enabled,\n    page_has_respondent_prod.flashver,\n    page_has_respondent_prod.num_pi,\n    page_has_respondent_prod.imported,\n    page_has_respondent_prod.script_versions,\n    page_has_respondent_prod.tracking_persistence,\n    page_has_respondent_prod.successor,\n    page_has_respondent_prod.idbucket\n   FROM live.page_has_respondent_prod;"));
    }

    /**
     * Create an aliased <code>live_core.page_has_respondent_prod</code> table
     * reference
     */
    ...
    /**
     * Create a <code>live_core.page_has_respondent_prod</code> table reference
     */
