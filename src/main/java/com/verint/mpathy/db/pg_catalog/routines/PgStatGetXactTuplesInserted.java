...
public class PgStatGetXactTuplesInserted extends AbstractRoutine<Long> {
    ...
    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_xact_tuples_inserted.RETURN_VALUE</code>.
     */
    public static final Parameter<Long> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BIGINT, false, false);

    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_xact_tuples_inserted._1</code>.
     */
    ...
    public PgStatGetXactTuplesInserted() {
        super("pg_stat_get_xact_tuples_inserted", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
