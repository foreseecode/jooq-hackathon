...
public class PgStatGetDbChecksumFailures extends AbstractRoutine<Long> {
     ...
     */
    public PgStatGetDbChecksumFailures() {
        super("pg_stat_get_db_checksum_failures", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
