...
public class BrinBloomAddValue extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.brin_bloom_add_value.RETURN_VALUE</code>.
     */
     ...
     */
    public BrinBloomAddValue() {
        super("brin_bloom_add_value", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN);
