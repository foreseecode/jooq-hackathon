...
public class PgStatGetXactFunctionTotalTime extends AbstractRoutine<Double> {
    ...
    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_xact_function_total_time.RETURN_VALUE</code>.
     */
    public static final Parameter<Double> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.DOUBLE, false, false);

    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_xact_function_total_time._1</code>.
     */
    ...
    public PgStatGetXactFunctionTotalTime() {
        super("pg_stat_get_xact_function_total_time", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
