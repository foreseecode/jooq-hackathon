...
public class PgStatGetXactTuplesHotUpdated extends AbstractRoutine<Long> {
    ...
    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_xact_tuples_hot_updated.RETURN_VALUE</code>.
     */
    public static final Parameter<Long> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BIGINT, false, false);

    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_xact_tuples_hot_updated._1</code>.
     */
    ...
    public PgStatGetXactTuplesHotUpdated() {
        super("pg_stat_get_xact_tuples_hot_updated", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
