...
public class Hashbpcharextended extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.hashbpcharextended.RETURN_VALUE</code>.
     */
     ...
     */
    public Hashbpcharextended() {
        super("hashbpcharextended", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
