...
public class HeapTableamHandler extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"table_am_handler\""), false, false);
     ...
     */
    public HeapTableamHandler() {
        super("heap_tableam_handler", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"table_am_handler\""));
