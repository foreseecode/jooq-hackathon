...
public class PgStatAllTablesRecord extends TableRecordImpl<PgStatAllTablesRecord> {
     ...
     */
    public PgStatAllTablesRecord(Long relid, String schemaname, String relname, Long seqScan, Long seqTupRead, Long idxScan, Long idxTupFetch, Long nTupIns, Long nTupUpd, Long nTupDel, Long nTupHotUpd, Long nLiveTup, Long nDeadTup, Long nModSinceAnalyze, Long nInsSinceVacuum, OffsetDateTime lastVacuum, OffsetDateTime lastAutovacuum, OffsetDateTime lastAnalyze, OffsetDateTime lastAutoanalyze, Long vacuumCount, Long autovacuumCount, Long analyzeCount, Long autoanalyzeCount) {
        super(PgStatAllTables.PG_STAT_ALL_TABLES);
