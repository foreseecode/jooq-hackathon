...
public class BrinMinmaxMultiDistanceInt4 extends AbstractRoutine<Double> {
     ...
     */
    public BrinMinmaxMultiDistanceInt4() {
        super("brin_minmax_multi_distance_int4", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
