...
public class Overlaps1 extends AbstractRoutine<Boolean> {
     ...
     */
    public static final Parameter<OffsetTime> _3 = Internal.createParameter("_3", SQLDataType.TIMEWITHTIMEZONE(6), false, true);

    /**
     * The parameter <code>pg_catalog.overlaps._4</code>.
     */
    public static final Parameter<OffsetTime> _4 = Internal.createParameter("_4", SQLDataType.TIMEWITHTIMEZONE(6), false, true);
