...
public class Regcollationout extends AbstractRoutine<Object> {
     ...
     */
    public Regcollationout() {
        super("regcollationout", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
