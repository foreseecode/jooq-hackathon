...
public class AnycompatiblerangeIn extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anycompatiblerange\""), false, false);
    ...
    /**
     * The parameter <code>pg_catalog.anycompatiblerange_in._2</code>.
     */
    public static final Parameter<Long> _2 = Internal.createParameter("_2", SQLDataType.BIGINT, false, true);

    /**
     * The parameter <code>pg_catalog.anycompatiblerange_in._3</code>.
     */
     ...
     */
    public AnycompatiblerangeIn() {
        super("anycompatiblerange_in", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anycompatiblerange\""));
