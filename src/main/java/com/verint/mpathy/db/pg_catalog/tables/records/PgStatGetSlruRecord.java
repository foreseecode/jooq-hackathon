...
public class PgStatGetSlruRecord extends TableRecordImpl<PgStatGetSlruRecord> implements Record9<String, Long, Long, Long, Long, Long, Long, Long, OffsetDateTime> {
    ...
    @Override
    public PgStatGetSlruRecord value1(String value) {
        setName(value);
        return this;
    }

    @Override
    public PgStatGetSlruRecord value2(Long value) {
        setBlksZeroed(value);
        return this;
    }

    @Override
    public PgStatGetSlruRecord value3(Long value) {
        setBlksHit(value);
        return this;
    }

    @Override
    public PgStatGetSlruRecord value4(Long value) {
        setBlksRead(value);
        return this;
    }

    @Override
    public PgStatGetSlruRecord value5(Long value) {
        setBlksWritten(value);
        return this;
    }

    @Override
    public PgStatGetSlruRecord value6(Long value) {
        setBlksExists(value);
        return this;
    }

    @Override
    public PgStatGetSlruRecord value7(Long value) {
        setFlushes(value);
        return this;
    }

    @Override
    public PgStatGetSlruRecord value8(Long value) {
        setTruncates(value);
        return this;
    }

    @Override
    public PgStatGetSlruRecord value9(OffsetDateTime value) {
        setStatsReset(value);
        return this;
    }

    @Override
    public PgStatGetSlruRecord values(String value1, Long value2, Long value3, Long value4, Long value5, Long value6, Long value7, Long value8, OffsetDateTime value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PgStatGetSlruRecord(String name, Long blksZeroed, Long blksHit, Long blksRead, Long blksWritten, Long blksExists, Long flushes, Long truncates, OffsetDateTime statsReset) {
        super(PgStatGetSlru.PG_STAT_GET_SLRU);
