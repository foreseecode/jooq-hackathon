...
public class SatisfiesHashPartition extends AbstractRoutine<Boolean> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> _4 = Internal.createParameter("_4", SQLDataType.OTHER, false, true);

    /**
     * Create a new routine call instance
     */
    public SatisfiesHashPartition() {
        super("satisfies_hash_partition", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN);
