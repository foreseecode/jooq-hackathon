...
public class PercentileContIntervalFinal extends AbstractRoutine<YearToSecond> {
    ...
    public PercentileContIntervalFinal() {
        super("percentile_cont_interval_final", PgCatalog.PG_CATALOG, SQLDataType.INTERVAL);
