...
public class PgMcvListItems extends TableImpl<PgMcvListItemsRecord> {
     ...
     */
    public final TableField<PgMcvListItemsRecord, String[]> VALUES = createField(DSL.name("values"), SQLDataType.CLOB.getArrayDataType(), this, "");

    /**
     * The column <code>pg_catalog.pg_mcv_list_items.nulls</code>.
     */
    public final TableField<PgMcvListItemsRecord, Boolean[]> NULLS = createField(DSL.name("nulls"), SQLDataType.BOOLEAN.getArrayDataType(), this, "");
