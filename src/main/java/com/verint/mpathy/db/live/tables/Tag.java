...
import com.verint.mpathy.db.live.tables.records.TagRecord;
...
public class Tag extends TableImpl<TagRecord> {
    ...
    /**
     * The reference instance of <code>live.tag</code>
     */
    ...
    /**
     * The column <code>live.tag.idtag</code>.
     */
    public final TableField<TagRecord, Long> IDTAG = createField(DSL.name("idtag"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>live.tag.name</code>.
     */
    ...
    /**
     * Create an aliased <code>live.tag</code> table reference
     */
    ...
    /**
     * Create a <code>live.tag</code> table reference
     */
    public Tag() {
