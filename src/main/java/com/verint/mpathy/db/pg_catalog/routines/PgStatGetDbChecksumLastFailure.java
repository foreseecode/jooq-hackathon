...
public class PgStatGetDbChecksumLastFailure extends AbstractRoutine<OffsetDateTime> {
     ...
     */
    public PgStatGetDbChecksumLastFailure() {
        super("pg_stat_get_db_checksum_last_failure", PgCatalog.PG_CATALOG, SQLDataType.TIMESTAMPWITHTIMEZONE(6));
