...
public class PgStatGetDbSessions extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_db_sessions.RETURN_VALUE</code>.
     */
    public static final Parameter<Long> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>pg_catalog.pg_stat_get_db_sessions._1</code>.
     */
     ...
     */
    public PgStatGetDbSessions() {
        super("pg_stat_get_db_sessions", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
