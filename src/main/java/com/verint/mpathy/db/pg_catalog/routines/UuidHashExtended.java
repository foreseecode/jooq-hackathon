...
public class UuidHashExtended extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.uuid_hash_extended.RETURN_VALUE</code>.
     */
     ...
     */
    public UuidHashExtended() {
        super("uuid_hash_extended", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
