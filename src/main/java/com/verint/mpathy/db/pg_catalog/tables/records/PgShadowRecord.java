...
public class PgShadowRecord extends TableRecordImpl<PgShadowRecord> implements Record9<String, Long, Boolean, Boolean, Boolean, Boolean, String, OffsetDateTime, String[]> {
    ...
    @Override
    public PgShadowRecord value8(OffsetDateTime value) {
        setValuntil(value);
        return this;
    }
    ...
    @Override
    public PgShadowRecord values(String value1, Long value2, Boolean value3, Boolean value4, Boolean value5, Boolean value6, String value7, OffsetDateTime value8, String[] value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
