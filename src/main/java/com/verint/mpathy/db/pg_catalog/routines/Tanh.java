...
public class Tanh extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.tanh.RETURN_VALUE</code>.
     */
    public static final Parameter<Double> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.DOUBLE, false, false);

    /**
     * The parameter <code>pg_catalog.tanh._1</code>.
     */
     ...
     */
    public Tanh() {
        super("tanh", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
