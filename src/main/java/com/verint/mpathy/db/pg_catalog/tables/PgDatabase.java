...
public class PgDatabase extends TableImpl<PgDatabaseRecord> {
     ...
     */
    public final TableField<PgDatabaseRecord, String> DATCOLLATE = createField(DSL.name("datcollate"), SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_database.datctype</code>.
     */
    public final TableField<PgDatabaseRecord, String> DATCTYPE = createField(DSL.name("datctype"), SQLDataType.VARCHAR.nullable(false), this, "");
     ...
     */
    public final TableField<PgDatabaseRecord, Long> DATLASTSYSOID = createField(DSL.name("datlastsysoid"), SQLDataType.BIGINT.nullable(false), this, "");
     ...
     */
    public final TableField<PgDatabaseRecord, String[]> DATACL = createField(DSL.name("datacl"), SQLDataType.VARCHAR.getArrayDataType(), this, "");
