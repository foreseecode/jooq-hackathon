...
public class PgStatGetDbConflictSnapshot extends AbstractRoutine<Long> {
    ...
    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_db_conflict_snapshot.RETURN_VALUE</code>.
     */
    public static final Parameter<Long> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BIGINT, false, false);

    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_db_conflict_snapshot._1</code>.
     */
    ...
    public PgStatGetDbConflictSnapshot() {
        super("pg_stat_get_db_conflict_snapshot", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
