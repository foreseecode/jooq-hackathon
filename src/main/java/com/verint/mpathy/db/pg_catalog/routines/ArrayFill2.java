...
public class ArrayFill2 extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anyarray\""), false, false);
     ...
     */
    public static final Parameter<Integer[]> _2 = Internal.createParameter("_2", SQLDataType.INTEGER.getArrayDataType(), false, true);

    /**
     * The parameter <code>pg_catalog.array_fill._3</code>.
     */
    public static final Parameter<Integer[]> _3 = Internal.createParameter("_3", SQLDataType.INTEGER.getArrayDataType(), false, true);
