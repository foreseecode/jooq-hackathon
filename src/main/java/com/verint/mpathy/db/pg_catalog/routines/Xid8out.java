...
public class Xid8out extends AbstractRoutine<Object> {
     ...
     */
    public Xid8out() {
        super("xid8out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
