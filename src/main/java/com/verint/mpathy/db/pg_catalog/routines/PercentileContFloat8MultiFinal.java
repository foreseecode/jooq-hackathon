...
public class PercentileContFloat8MultiFinal extends AbstractRoutine<Double[]> {
     ...
     */
    public static final Parameter<Double[]> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.FLOAT.getArrayDataType(), false, false);
    ...
    public PercentileContFloat8MultiFinal() {
        super("percentile_cont_float8_multi_final", PgCatalog.PG_CATALOG, SQLDataType.FLOAT.getArrayDataType());
