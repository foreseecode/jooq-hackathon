...
public class Btnametextcmp extends AbstractRoutine<Integer> {
     ...
     */
    public Btnametextcmp() {
        super("btnametextcmp", PgCatalog.PG_CATALOG, SQLDataType.INTEGER);
