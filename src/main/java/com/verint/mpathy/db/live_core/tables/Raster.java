...
import com.verint.mpathy.db.live_core.tables.records.RasterRecord;
...
public class Raster extends TableImpl<RasterRecord> {
    ...
    /**
     * The reference instance of <code>live_core.raster</code>
     */
    ...
    private Raster(Name alias, Table<RasterRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"raster\" as  SELECT raster.x,\n    raster.y,\n    raster.polygon\n   FROM live.raster;"));
    }

    /**
     * Create an aliased <code>live_core.raster</code> table reference
     */
    ...
    /**
     * Create a <code>live_core.raster</code> table reference
     */
    public Raster() {
