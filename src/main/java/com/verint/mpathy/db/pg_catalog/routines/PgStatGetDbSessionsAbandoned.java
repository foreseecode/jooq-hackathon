...
public class PgStatGetDbSessionsAbandoned extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_db_sessions_abandoned.RETURN_VALUE</code>.
     */
    public static final Parameter<Long> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BIGINT, false, false);

    /**
     * The parameter
     * <code>pg_catalog.pg_stat_get_db_sessions_abandoned._1</code>.
     */
     ...
     */
    public PgStatGetDbSessionsAbandoned() {
        super("pg_stat_get_db_sessions_abandoned", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
