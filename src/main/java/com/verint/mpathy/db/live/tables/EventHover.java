...
import com.verint.mpathy.db.live.tables.records.EventHoverRecord;
...
public class EventHover extends TableImpl<EventHoverRecord> {
    ...
    /**
     * The reference instance of <code>live.event_hover</code>
     */
    ...
    /**
     * The column <code>live.event_hover.idpage</code>.
     */
    public final TableField<EventHoverRecord, BigDecimal> IDPAGE = createField(DSL.name("idpage"), SQLDataType.NUMERIC.nullable(false), this, "");

    /**
     * The column <code>live.event_hover.idelement</code>.
     */
    public final TableField<EventHoverRecord, BigDecimal> IDELEMENT = createField(DSL.name("idelement"), SQLDataType.NUMERIC.nullable(false), this, "");

    /**
     * The column <code>live.event_hover.timestamp</code>.
     */
    public final TableField<EventHoverRecord, BigDecimal> TIMESTAMP = createField(DSL.name("timestamp"), SQLDataType.NUMERIC.nullable(false), this, "");

    /**
     * The column <code>live.event_hover.idsession</code>.
     */
    public final TableField<EventHoverRecord, BigDecimal> IDSESSION = createField(DSL.name("idsession"), SQLDataType.NUMERIC, this, "");

    /**
     * The column <code>live.event_hover.idsite</code>.
     */
    public final TableField<EventHoverRecord, Integer> IDSITE = createField(DSL.name("idsite"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>live.event_hover.idurl</code>.
     */
    public final TableField<EventHoverRecord, Long> IDURL = createField(DSL.name("idurl"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>live.event_hover.idpage_name</code>.
     */
    public final TableField<EventHoverRecord, Long> IDPAGE_NAME = createField(DSL.name("idpage_name"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>live.event_hover.idtime_successor</code>.
     */
    ...
    /**
     * The column <code>live.event_hover.idpage_successor</code>.
     */
    ...
    /**
     * The column <code>live.event_hover.idelement_successor</code>.
     */
    ...
    /**
     * The column <code>live.event_hover.timestamp_successor</code>.
     */
    ...
    /**
     * The column <code>live.event_hover.hovertime</code>.
     */
    ...
    /**
     * Create an aliased <code>live.event_hover</code> table reference
     */
    ...
    /**
     * Create a <code>live.event_hover</code> table reference
     */
    public EventHover() {
