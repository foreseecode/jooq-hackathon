...
public class MultirangeOut extends AbstractRoutine<Object> {
     ...
     */
    public MultirangeOut() {
        super("multirange_out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
