...
public class PgStatGetReplicationSlot extends TableImpl<PgStatGetReplicationSlotRecord> {
     ...
     */
    public final TableField<PgStatGetReplicationSlotRecord, OffsetDateTime> STATS_RESET = createField(DSL.name("stats_reset"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");
