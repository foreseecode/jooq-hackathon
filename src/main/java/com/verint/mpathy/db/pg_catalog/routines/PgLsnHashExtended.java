...
public class PgLsnHashExtended extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.pg_lsn_hash_extended.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.pg_lsn_hash_extended._2</code>.
     */
     ...
     */
    public PgLsnHashExtended() {
        super("pg_lsn_hash_extended", PgCatalog.PG_CATALOG, SQLDataType.BIGINT);
