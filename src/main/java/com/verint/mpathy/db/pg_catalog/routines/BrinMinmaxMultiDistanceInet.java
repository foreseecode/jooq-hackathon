...
public class BrinMinmaxMultiDistanceInet extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.brin_minmax_multi_distance_inet.RETURN_VALUE</code>.
     */
     ...
     */
    public BrinMinmaxMultiDistanceInet() {
        super("brin_minmax_multi_distance_inet", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
