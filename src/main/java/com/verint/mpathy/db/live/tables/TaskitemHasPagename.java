...
import com.verint.mpathy.db.live.tables.records.TaskitemHasPagenameRecord;
...
public class TaskitemHasPagename extends TableImpl<TaskitemHasPagenameRecord> {
    ...
    /**
     * The reference instance of <code>live.taskitem_has_pagename</code>
     */
    ...
    /**
     * The column <code>live.taskitem_has_pagename.idpage_name</code>.
     */
    public final TableField<TaskitemHasPagenameRecord, Long> IDPAGE_NAME = createField(DSL.name("idpage_name"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>live.taskitem_has_pagename.idtaskitem</code>.
     */
    public final TableField<TaskitemHasPagenameRecord, BigDecimal> IDTASKITEM = createField(DSL.name("idtaskitem"), SQLDataType.NUMERIC.nullable(false), this, "");
    ...
    private TaskitemHasPagename(Name alias, Table<TaskitemHasPagenameRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Reference table between \"task_item\" and \"page_name\" to define the form step condition."), TableOptions.table());
    }

    /**
     * Create an aliased <code>live.taskitem_has_pagename</code> table reference
     */
    ...
    /**
     * Create a <code>live.taskitem_has_pagename</code> table reference
     */
