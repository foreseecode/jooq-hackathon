...
import com.verint.mpathy.db.live_core.tables.records.MapFocusRecord;
...
public class MapFocus extends TableImpl<MapFocusRecord> {
    ...
    /**
     * The reference instance of <code>live_core.map_focus</code>
     */
    ...
    private MapFocus(Name alias, Table<MapFocusRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"map_focus\" as  SELECT map_focus.idsite,\n    map_focus.x,\n    map_focus.y,\n    map_focus.sum,\n    map_focus.sessions\n   FROM live.map_focus;"));
    }

    /**
     * Create an aliased <code>live_core.map_focus</code> table reference
     */
    ...
    /**
     * Create a <code>live_core.map_focus</code> table reference
     */
    public MapFocus() {
