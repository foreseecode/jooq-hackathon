...
public class BrinMinmaxMultiOptions extends AbstractRoutine<java.lang.Void> {
     ...
     */
    public BrinMinmaxMultiOptions() {
        super("brin_minmax_multi_options", PgCatalog.PG_CATALOG);
