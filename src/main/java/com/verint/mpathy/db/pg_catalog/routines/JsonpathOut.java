...
public class JsonpathOut extends AbstractRoutine<Object> {
     ...
     */
    public JsonpathOut() {
        super("jsonpath_out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
