...
import com.verint.mpathy.db.live_core.tables.records.ComscoreFilterRecord;
...
public class ComscoreFilter extends TableImpl<ComscoreFilterRecord> {
    ...
    /**
     * The reference instance of <code>live_core.comscore_filter</code>
     */
    ...
    /**
     * The column <code>live_core.comscore_filter.idclient</code>.
     */
    public final TableField<ComscoreFilterRecord, BigDecimal> IDCLIENT = createField(DSL.name("idclient"), SQLDataType.NUMERIC, this, "");

    /**
     * The column <code>live_core.comscore_filter.idfilter</code>.
     */
    public final TableField<ComscoreFilterRecord, BigDecimal> IDFILTER = createField(DSL.name("idfilter"), SQLDataType.NUMERIC, this, "");

    /**
     * The column <code>live_core.comscore_filter.name</code>.
     */
    public final TableField<ComscoreFilterRecord, String> NAME = createField(DSL.name("name"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>live_core.comscore_filter.scope</code>.
     */
    ...
    private ComscoreFilter(Name alias, Table<ComscoreFilterRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"comscore_filter\" as  SELECT comscore_filter.idclient,\n    comscore_filter.idfilter,\n    comscore_filter.name,\n    comscore_filter.scope\n   FROM live.comscore_filter;"));
    }

    /**
     * Create an aliased <code>live_core.comscore_filter</code> table reference
     */
    ...
    /**
     * Create a <code>live_core.comscore_filter</code> table reference
     */
