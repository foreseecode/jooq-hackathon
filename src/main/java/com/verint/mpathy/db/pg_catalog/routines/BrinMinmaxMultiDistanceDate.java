...
public class BrinMinmaxMultiDistanceDate extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter
     * <code>pg_catalog.brin_minmax_multi_distance_date.RETURN_VALUE</code>.
     */
     ...
     */
    public BrinMinmaxMultiDistanceDate() {
        super("brin_minmax_multi_distance_date", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
