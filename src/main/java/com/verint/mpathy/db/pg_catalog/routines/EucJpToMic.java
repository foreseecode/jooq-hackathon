...
public class EucJpToMic extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.euc_jp_to_mic.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.euc_jp_to_mic._6</code>.
     */
     ...
     */
    public EucJpToMic() {
        super("euc_jp_to_mic", PgCatalog.PG_CATALOG, SQLDataType.INTEGER);
