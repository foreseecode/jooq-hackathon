...
public class MicToEucJp extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.mic_to_euc_jp.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.mic_to_euc_jp._6</code>.
     */
     ...
     */
    public MicToEucJp() {
        super("mic_to_euc_jp", PgCatalog.PG_CATALOG, SQLDataType.INTEGER);
