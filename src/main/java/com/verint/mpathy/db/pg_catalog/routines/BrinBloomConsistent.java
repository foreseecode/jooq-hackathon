...
public class BrinBloomConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.brin_bloom_consistent.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.brin_bloom_consistent._4</code>.
     */
     ...
     */
    public BrinBloomConsistent() {
        super("brin_bloom_consistent", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN);
