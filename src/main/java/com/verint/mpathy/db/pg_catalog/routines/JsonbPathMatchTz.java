...
public class JsonbPathMatchTz extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.jsonb_path_match_tz.RETURN_VALUE</code>.
     */
    public static final Parameter<Boolean> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BOOLEAN, false, false);

    /**
     * The parameter <code>pg_catalog.jsonb_path_match_tz.target</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.jsonb_path_match_tz.vars</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.jsonb_path_match_tz.silent</code>.
     */
     ...
     */
    public JsonbPathMatchTz() {
        super("jsonb_path_match_tz", PgCatalog.PG_CATALOG, SQLDataType.BOOLEAN);
