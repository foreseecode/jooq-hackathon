...
public class AnycompatibleOut extends AbstractRoutine<Object> {
     ...
     */
    public AnycompatibleOut() {
        super("anycompatible_out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
