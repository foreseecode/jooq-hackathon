...
public class JsonpathIn extends AbstractRoutine<Object> {
     ...
     */
    public JsonpathIn() {
        super("jsonpath_in", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"jsonpath\""));
