...
public class PgSnapshotOut extends AbstractRoutine<Object> {
     ...
     */
    public PgSnapshotOut() {
        super("pg_snapshot_out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
