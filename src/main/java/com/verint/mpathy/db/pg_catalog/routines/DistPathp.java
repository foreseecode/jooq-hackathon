...
public class DistPathp extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>pg_catalog.dist_pathp.RETURN_VALUE</code>.
     */
     ...
     */
    public DistPathp() {
        super("dist_pathp", PgCatalog.PG_CATALOG, SQLDataType.DOUBLE);
