...
import com.verint.mpathy.db.live_core.tables.records.PageStatsRecord;
...
public class PageStats extends TableImpl<PageStatsRecord> {
    ...
    /**
     * The reference instance of <code>live_core.page_stats</code>
     */
    ...
    /**
     * The column <code>live_core.page_stats.script_versions</code>.
     */
    public final TableField<PageStatsRecord, String> SCRIPT_VERSIONS = createField(DSL.name("script_versions"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>live_core.page_stats.error_code</code>.
     */
    ...
    private PageStats(Name alias, Table<PageStatsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Easy access to underlying table in other schemas."), TableOptions.view("create view \"page_stats\" as  SELECT page_stats.idpage,\n    page_stats.idsession,\n    page_stats.idsite,\n    page_stats.pagename,\n    page_stats.url,\n    page_stats.date,\n    page_stats.type,\n    page_stats.msg,\n    page_stats.script_url,\n    page_stats.ua_string,\n    page_stats.idvisitor,\n    page_stats.has_valid_scaffold,\n    page_stats.script_versions,\n    page_stats.error_code\n   FROM live.page_stats;"));
    }

    /**
     * Create an aliased <code>live_core.page_stats</code> table reference
     */
    ...
    /**
     * Create a <code>live_core.page_stats</code> table reference
     */
    public PageStats() {
